...
/**
 * Service class containing states process used to drive state machine "CocrdslcProcedureDivisionStateMachine".
 */
@Service("aws.bluage.l3.workshop.cocrdslc.statemachine.CocrdslcProcedureDivisionStateMachineService")
@Lazy
public class CocrdslcProcedureDivisionStateMachineService {
	
	/**
	 * The logger.
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(CocrdslcProcedureDivisionStateMachineService.class);

	/**
	 * The associated state machine controller.
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cocrdslc.statemachine.CocrdslcProcedureDivisionStateMachineController")	
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cocrdslc.service.CocrdslcProcess")
	private CocrdslcProcess instanceCocrdslcProcess;
	 ...
	 * @param ctrl 
	 */
	void _0000Main(CocrdslcContext ctx, ExecutionController ctrl) {
		...
		**************************************************************** */
		instanceCocrdslcProcess.yyyyStorePfkey(ctx, ctrl);
	 ...
	 * @param ctrl 
	 */
	void abendRoutine(CocrdslcContext ctx, ExecutionController ctrl) {
