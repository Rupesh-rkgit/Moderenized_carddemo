...
/**
 * Reference the spring application of program COBIL00C.
 *  Provides an access to the contained program for the run unit.
 */
@Component
@Import({
	aws.bluage.l3.workshop.cobil00c.business.context.Cobil00cConfiguration.class,
	aws.bluage.l3.workshop.cobil00c.business.context.Cobil00cContext.class,
	aws.bluage.l3.workshop.cobil00c.service.impl.Cobil00cProcessImpl.class
})
public class Cobil00c implements Program {
	/**
	 * Unique identifiers for the contained program.
	 */
	private static final Set<String> programIdentifiers = Collections.unmodifiableSet(Stream.of("COBIL00C").collect(Collectors.toSet()));

	/**
	 * Main program identifier for the contained program.
	 */
	private static final String programIdentifier = "COBIL00C";
	@Autowired
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cobil00c.service.Cobil00cProcess")
	private Cobil00cProcess instanceCobil00cProcess;
	
	@Override
	public void run(ExecutionController ctrl) {
		instanceCobil00cProcess.mainPara((Cobil00cContext) getContext(), ctrl);
	}	
