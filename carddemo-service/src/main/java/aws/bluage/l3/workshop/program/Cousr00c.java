...
/**
 * Reference the spring application of program COUSR00C.
 *  Provides an access to the contained program for the run unit.
 */
@Component
@Import({
	aws.bluage.l3.workshop.cousr00c.business.context.Cousr00cConfiguration.class,
	aws.bluage.l3.workshop.cousr00c.business.context.Cousr00cContext.class,
	aws.bluage.l3.workshop.cousr00c.service.impl.Cousr00cProcessImpl.class
})
public class Cousr00c implements Program {
	/**
	 * Unique identifiers for the contained program.
	 */
	private static final Set<String> programIdentifiers = Collections.unmodifiableSet(Stream.of("COUSR00C").collect(Collectors.toSet()));

	/**
	 * Main program identifier for the contained program.
	 */
	private static final String programIdentifier = "COUSR00C";
	@Autowired
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cousr00c.service.Cousr00cProcess")
	private Cousr00cProcess instanceCousr00cProcess;
	
	@Override
	public void run(ExecutionController ctrl) {
		instanceCousr00cProcess.mainPara((Cousr00cContext) getContext(), ctrl);
	}	
