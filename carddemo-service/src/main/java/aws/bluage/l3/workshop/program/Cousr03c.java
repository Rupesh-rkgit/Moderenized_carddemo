...
/**
 * Reference the spring application of program COUSR03C.
 *  Provides an access to the contained program for the run unit.
 */
@Component
@Import({
	aws.bluage.l3.workshop.cousr03c.business.context.Cousr03cConfiguration.class,
	aws.bluage.l3.workshop.cousr03c.business.context.Cousr03cContext.class,
	aws.bluage.l3.workshop.cousr03c.service.impl.Cousr03cProcessImpl.class
})
public class Cousr03c implements Program {
	/**
	 * Unique identifiers for the contained program.
	 */
	private static final Set<String> programIdentifiers = Collections.unmodifiableSet(Stream.of("COUSR03C").collect(Collectors.toSet()));

	/**
	 * Main program identifier for the contained program.
	 */
	private static final String programIdentifier = "COUSR03C";
	@Autowired
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cousr03c.service.Cousr03cProcess")
	private Cousr03cProcess instanceCousr03cProcess;
	
	@Override
	public void run(ExecutionController ctrl) {
		instanceCousr03cProcess.mainPara((Cousr03cContext) getContext(), ctrl);
	}	
