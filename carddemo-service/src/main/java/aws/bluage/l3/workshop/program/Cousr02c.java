...
/**
 * Reference the spring application of program COUSR02C.
 *  Provides an access to the contained program for the run unit.
 */
@Component
@Import({
	aws.bluage.l3.workshop.cousr02c.business.context.Cousr02cConfiguration.class,
	aws.bluage.l3.workshop.cousr02c.business.context.Cousr02cContext.class,
	aws.bluage.l3.workshop.cousr02c.service.impl.Cousr02cProcessImpl.class
})
public class Cousr02c implements Program {
	/**
	 * Unique identifiers for the contained program.
	 */
	private static final Set<String> programIdentifiers = Collections.unmodifiableSet(Stream.of("COUSR02C").collect(Collectors.toSet()));

	/**
	 * Main program identifier for the contained program.
	 */
	private static final String programIdentifier = "COUSR02C";
	@Autowired
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cousr02c.service.Cousr02cProcess")
	private Cousr02cProcess instanceCousr02cProcess;
	
	@Override
	public void run(ExecutionController ctrl) {
		instanceCousr02cProcess.mainPara((Cousr02cContext) getContext(), ctrl);
	}	
