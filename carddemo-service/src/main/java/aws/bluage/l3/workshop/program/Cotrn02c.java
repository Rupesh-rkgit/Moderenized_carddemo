...
/**
 * Reference the spring application of program COTRN02C.
 *  Provides an access to the contained program for the run unit.
 */
@Component
@Import({
	aws.bluage.l3.workshop.cotrn02c.business.context.Cotrn02cConfiguration.class,
	aws.bluage.l3.workshop.cotrn02c.business.context.Cotrn02cContext.class,
	aws.bluage.l3.workshop.cotrn02c.service.impl.Cotrn02cProcessImpl.class
})
public class Cotrn02c implements Program {
	/**
	 * Unique identifiers for the contained program.
	 */
	private static final Set<String> programIdentifiers = Collections.unmodifiableSet(Stream.of("COTRN02C").collect(Collectors.toSet()));

	/**
	 * Main program identifier for the contained program.
	 */
	private static final String programIdentifier = "COTRN02C";
	@Autowired
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cotrn02c.service.Cotrn02cProcess")
	private Cotrn02cProcess instanceCotrn02cProcess;
	
	@Override
	public void run(ExecutionController ctrl) {
		instanceCotrn02cProcess.mainPara((Cotrn02cContext) getContext(), ctrl);
	}	
