...
/**
 * Reference the spring application of program CBSTM03B.
 *  Provides an access to the contained program for the run unit.
 */
@Component
@Import({
	aws.bluage.l3.workshop.cbstm03b.business.context.Cbstm03bConfiguration.class,
	aws.bluage.l3.workshop.cbstm03b.business.context.Cbstm03bContext.class,
	aws.bluage.l3.workshop.cbstm03b.service.impl.Cbstm03bProcessImpl.class
})
public class Cbstm03b implements Program {
	/**
	 * Unique identifiers for the contained program.
	 */
	private static final Set<String> programIdentifiers = Collections.unmodifiableSet(Stream.of("CBSTM03B").collect(Collectors.toSet()));

	/**
	 * Main program identifier for the contained program.
	 */
	private static final String programIdentifier = "CBSTM03B";
	@Autowired
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cbstm03b.service.Cbstm03bProcess")
	private Cbstm03bProcess instanceCbstm03bProcess;
	
	@Override
	public void run(ExecutionController ctrl) {
		instanceCbstm03bProcess.start((Cbstm03bContext) getContext(), ctrl);
	}	
