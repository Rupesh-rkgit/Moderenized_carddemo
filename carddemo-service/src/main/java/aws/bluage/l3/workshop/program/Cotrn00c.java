...
/**
 * Reference the spring application of program COTRN00C.
 *  Provides an access to the contained program for the run unit.
 */
@Component
@Import({
	aws.bluage.l3.workshop.cotrn00c.business.context.Cotrn00cConfiguration.class,
	aws.bluage.l3.workshop.cotrn00c.business.context.Cotrn00cContext.class,
	aws.bluage.l3.workshop.cotrn00c.service.impl.Cotrn00cProcessImpl.class
})
public class Cotrn00c implements Program {
	/**
	 * Unique identifiers for the contained program.
	 */
	private static final Set<String> programIdentifiers = Collections.unmodifiableSet(Stream.of("COTRN00C").collect(Collectors.toSet()));

	/**
	 * Main program identifier for the contained program.
	 */
	private static final String programIdentifier = "COTRN00C";
	@Autowired
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cotrn00c.service.Cotrn00cProcess")
	private Cotrn00cProcess instanceCotrn00cProcess;
	
	@Override
	public void run(ExecutionController ctrl) {
		instanceCotrn00cProcess.mainPara((Cotrn00cContext) getContext(), ctrl);
	}	
