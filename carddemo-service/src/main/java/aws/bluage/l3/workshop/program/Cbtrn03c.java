...
/**
 * Reference the spring application of program CBTRN03C.
 *  Provides an access to the contained program for the run unit.
 */
@Component
@Import({
	aws.bluage.l3.workshop.cbtrn03c.business.context.Cbtrn03cConfiguration.class,
	aws.bluage.l3.workshop.cbtrn03c.business.context.Cbtrn03cContext.class,
	aws.bluage.l3.workshop.cbtrn03c.service.impl.Cbtrn03cProcessImpl.class
})
public class Cbtrn03c implements Program {
	/**
	 * Unique identifiers for the contained program.
	 */
	private static final Set<String> programIdentifiers = Collections.unmodifiableSet(Stream.of("CBTRN03C").collect(Collectors.toSet()));

	/**
	 * Main program identifier for the contained program.
	 */
	private static final String programIdentifier = "CBTRN03C";
	@Autowired
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.cbtrn03c.service.Cbtrn03cProcess")
	private Cbtrn03cProcess instanceCbtrn03cProcess;
	
	@Override
	public void run(ExecutionController ctrl) {
		instanceCbtrn03cProcess.procedureDivision((Cbtrn03cContext) getContext(), ctrl);
	}	
