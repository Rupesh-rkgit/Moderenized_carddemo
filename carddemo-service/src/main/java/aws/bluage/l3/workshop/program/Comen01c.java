...
/**
 * Reference the spring application of program COMEN01C.
 *  Provides an access to the contained program for the run unit.
 */
@Component
@Import({
	aws.bluage.l3.workshop.comen01c.business.context.Comen01cConfiguration.class,
	aws.bluage.l3.workshop.comen01c.business.context.Comen01cContext.class,
	aws.bluage.l3.workshop.comen01c.service.impl.Comen01cProcessImpl.class
})
public class Comen01c implements Program {
	/**
	 * Unique identifiers for the contained program.
	 */
	private static final Set<String> programIdentifiers = Collections.unmodifiableSet(Stream.of("COMEN01C").collect(Collectors.toSet()));

	/**
	 * Main program identifier for the contained program.
	 */
	private static final String programIdentifier = "COMEN01C";
	@Autowired
	 ...
	 */
	@Autowired
	@Qualifier("aws.bluage.l3.workshop.comen01c.service.Comen01cProcess")
	private Comen01cProcess instanceComen01cProcess;
	
	@Override
	public void run(ExecutionController ctrl) {
		instanceComen01cProcess.mainPara((Comen01cContext) getContext(), ctrl);
	}	
