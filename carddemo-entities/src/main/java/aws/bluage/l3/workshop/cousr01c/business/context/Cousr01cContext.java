package aws.bluage.l3.workshop.cousr01c.business.context;
import aws.bluage.l3.workshop.cousr01c.business.model.CarddemoCommarea;
import aws.bluage.l3.workshop.cousr01c.business.model.CcdaCommonMessages;
import aws.bluage.l3.workshop.cousr01c.business.model.CcdaScreenTitle;
import aws.bluage.l3.workshop.cousr01c.business.model.Dfhaid;
import aws.bluage.l3.workshop.cousr01c.business.model.Dfhbmsca;
import aws.bluage.l3.workshop.cousr01c.business.model.Dfhcommarea;
import aws.bluage.l3.workshop.cousr01c.business.model.Dfheiblk;
import aws.bluage.l3.workshop.cousr01c.business.model.Group1;
import aws.bluage.l3.workshop.cousr01c.business.model.SecUserData;
import aws.bluage.l3.workshop.cousr01c.business.model.WsDateTime;
import aws.bluage.l3.workshop.cousr01c.business.model.WsVariables;
...
/**
 * Data simplifier context Cousr01cContext.
 * 
 ...
 * </p>
 * 
 * <p>About 'wsVariables' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.WsVariables
 * <br></p>
 * 
 * <p>About 'carddemoCommarea' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.CarddemoCommarea
 * <br></p>
 * 
 * <p>About 'group1' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.Group1
 * <br></p>
 * 
 * <p>About 'ccdaScreenTitle' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.CcdaScreenTitle
 * <br></p>
 * 
 * <p>About 'wsDateTime' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.WsDateTime
 * <br></p>
 * 
 * <p>About 'ccdaCommonMessages' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.CcdaCommonMessages
 * <br></p>
 * 
 * <p>About 'secUserData' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.SecUserData
 * <br></p>
 * 
 * <p>About 'dfhaid' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.Dfhaid
 * <br></p>
 * 
 * <p>About 'dfhbmsca' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.Dfhbmsca
 * <br></p>
 * 
 * <p>About 'dfheiblk' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.Dfheiblk
 * <br></p>
 * 
 * <p>About 'dfhcommarea' field, <br>uml entity: aws.bluage.l3.workshop.cousr01c.business.model.Dfhcommarea
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.cousr01c.business.context.Cousr01cContext")
@Lazy
@Scope("prototype")
public class Cousr01cContext extends JicsRuntimeContext {
	 ...
	 */
	public Cousr01cContext (@Qualifier("Cousr01cContextConfiguration") Configuration configuration) {
		super(configuration);
	...
	private void initRecordEntities() {
		recordEntities = Arrays.asList(wsVariables, carddemoCommarea, group1, ccdaScreenTitle, wsDateTime, ccdaCommonMessages, secUserData, dfhaid, dfhbmsca);
	}
