 ...
 *  *****************************************************************<br>
 *   Program     : COUSR02C.CBL<br>
 *   Application : CardDemo<br>
 *   Type        : CICS COBOL Program<br>
 *   Function    : Update a user in USRSEC file<br>
 *  *****************************************************************<br>
...
public class WsVariables extends RecordEntity {
	...
	private final Elementary wsPgmname = new Elementary(root,new AlphanumericType(8),"COUSR02C");
	private final Elementary wsTranid = new Elementary(root,new AlphanumericType(4),"CU02");
