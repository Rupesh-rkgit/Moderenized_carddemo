 ...
 * 
 * <p>About 'fdTranfileRec' field, <br>uml entity: aws.bluage.l3.workshop.cbtrn02c.business.model.FdTranfileRec
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.cbtrn02c.business.model.TransactFile")
@Lazy
@Scope("prototype")
public class TransactFile extends RecordEntity {
	 ...
	 */
	public TransactFile(@Qualifier("Cbtrn02cContextConfiguration") Configuration configuration) {
		super(configuration);
		setupRoot(root);
	}
