package aws.bluage.l3.workshop.coadm01c.business.context;
import aws.bluage.l3.workshop.coadm01c.business.model.CarddemoAdminMenuOptions;
import aws.bluage.l3.workshop.coadm01c.business.model.CarddemoCommarea;
import aws.bluage.l3.workshop.coadm01c.business.model.CcdaCommonMessages;
import aws.bluage.l3.workshop.coadm01c.business.model.CcdaScreenTitle;
import aws.bluage.l3.workshop.coadm01c.business.model.Dfhaid;
import aws.bluage.l3.workshop.coadm01c.business.model.Dfhbmsca;
import aws.bluage.l3.workshop.coadm01c.business.model.Dfhcommarea;
import aws.bluage.l3.workshop.coadm01c.business.model.Dfheiblk;
import aws.bluage.l3.workshop.coadm01c.business.model.Group1;
import aws.bluage.l3.workshop.coadm01c.business.model.SecUserData;
import aws.bluage.l3.workshop.coadm01c.business.model.WsDateTime;
import aws.bluage.l3.workshop.coadm01c.business.model.WsVariables;
...
/**
 * Data simplifier context Coadm01cContext.
 * 
 ...
 * </p>
 * 
 * <p>About 'wsVariables' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.WsVariables
 * <br></p>
 * 
 * <p>About 'carddemoCommarea' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.CarddemoCommarea
 * <br></p>
 * 
 * <p>About 'carddemoAdminMenuOptions' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.CarddemoAdminMenuOptions
 * <br></p>
 * 
 * <p>About 'group1' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.Group1
 * <br></p>
 * 
 * <p>About 'ccdaScreenTitle' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.CcdaScreenTitle
 * <br></p>
 * 
 * <p>About 'wsDateTime' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.WsDateTime
 * <br></p>
 * 
 * <p>About 'ccdaCommonMessages' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.CcdaCommonMessages
 * <br></p>
 * 
 * <p>About 'secUserData' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.SecUserData
 * <br></p>
 * 
 * <p>About 'dfhaid' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.Dfhaid
 * <br></p>
 * 
 * <p>About 'dfhbmsca' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.Dfhbmsca
 * <br></p>
 * 
 * <p>About 'dfheiblk' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.Dfheiblk
 * <br></p>
 * 
 * <p>About 'dfhcommarea' field, <br>uml entity: aws.bluage.l3.workshop.coadm01c.business.model.Dfhcommarea
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.coadm01c.business.context.Coadm01cContext")
@Lazy
@Scope("prototype")
public class Coadm01cContext extends JicsRuntimeContext {
	
	private WsVariables wsVariables;
	private CarddemoCommarea carddemoCommarea;
	private CarddemoAdminMenuOptions carddemoAdminMenuOptions;
	 ...
	 */
	public Coadm01cContext (@Qualifier("Coadm01cContextConfiguration") Configuration configuration) {
		super(configuration);
	...
	/**
	 * Getter for carddemoAdminMenuOptions.
	 * @return the carddemoAdminMenuOptions
	 */
	public CarddemoAdminMenuOptions getCarddemoAdminMenuOptions() {
		return this.carddemoAdminMenuOptions;
	}

	/**
	 * Setter for carddemoAdminMenuOptions.
	 * @param reference the new value for carddemoAdminMenuOptions
	 */
	public void setCarddemoAdminMenuOptions(RangeReference reference) {
		this.carddemoAdminMenuOptions.setBytes(reference.getBytes());
	}
	...
	private void initWorking(Configuration configuration) {
		...
		carddemoAdminMenuOptions = new CarddemoAdminMenuOptions(configuration);
	...
	private void initRecordEntities() {
		recordEntities = Arrays.asList(wsVariables, carddemoCommarea, carddemoAdminMenuOptions, group1, ccdaScreenTitle, wsDateTime, ccdaCommonMessages, secUserData, dfhaid, dfhbmsca);
	}
