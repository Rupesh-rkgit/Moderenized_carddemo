 ...
 *  *****************************************************************<br>
 *   Program     : COUSR00C.CBL<br>
 *   Application : CardDemo<br>
 *   Type        : CICS COBOL Program<br>
 *   Function    : List all users from USRSEC file<br>
 *  *****************************************************************<br>
 ...
 * </p>
 * 
 * <p>About 'wsUserSecEof' field, <br>
 * </p>
 * 
 * <p>About 'userSecEof' field, <br>
 * </p>
 * 
 * <p>About 'userSecNotEof' field, <br>
 * </p>
 * 
...
public class WsVariables extends RecordEntity {
	...
	private final Elementary wsPgmname = new Elementary(root,new AlphanumericType(8),"COUSR00C");
	private final Elementary wsTranid = new Elementary(root,new AlphanumericType(4),"CU00");
	...
	private final Elementary wsUserSecEof = new Elementary(root,new AlphanumericType(1),"N");
	private final ConditionName userSecEof=new ConditionName(wsUserSecEof,"Y");
	private final ConditionName userSecNotEof=new ConditionName(wsUserSecEof,"N");
	...
	/**
	 * Gets the reference for attribute wsUserSecEof.
	 * @return the wsUserSecEof attribute reference
	 */
	public ElementaryRangeReference getWsUserSecEofReference() {
		return wsUserSecEof.getReference();
	}

	/**
	 * Getter for wsUserSecEof attribute.
	 * @return wsUserSecEof attribute
	 */
	public String getWsUserSecEof() {
		return wsUserSecEof.getValue();
	}

	/**
	 * Setter for wsUserSecEof attribute.
	 * @param wsUserSecEof the new value of wsUserSecEof
	 */
	public void setWsUserSecEof(String wsUserSecEof) {
		this.wsUserSecEof.setValue(wsUserSecEof);
	}
	/**
	 * Gets the reference for attribute userSecEof.
	 * @return the userSecEof attribute reference
	 */
	public ConditionReference getUserSecEofReference() {
		return wsUserSecEof.getCondition(userSecEof);	
	}

	/**
	 * Getter for userSecEof attribute.
	 * @return userSecEof attribute
	 */
	public boolean isUserSecEof() {
		return getUserSecEofReference().getValue();	
	}

	/**
	 * Setter for userSecEof attribute.
	 * @param userSecEof the new value of userSecEof
	 */
	public void setUserSecEof(boolean userSecEof) {
		getUserSecEofReference().setValue(userSecEof);	
	}
	/**
	 * Gets the reference for attribute userSecNotEof.
	 * @return the userSecNotEof attribute reference
	 */
	public ConditionReference getUserSecNotEofReference() {
		return wsUserSecEof.getCondition(userSecNotEof);	
	}

	/**
	 * Getter for userSecNotEof attribute.
	 * @return userSecNotEof attribute
	 */
	public boolean isUserSecNotEof() {
		return getUserSecNotEofReference().getValue();	
	}

	/**
	 * Setter for userSecNotEof attribute.
	 * @param userSecNotEof the new value of userSecNotEof
	 */
	public void setUserSecNotEof(boolean userSecNotEof) {
		getUserSecNotEofReference().setValue(userSecNotEof);	
	}
	/**
