 ...
 * 
 * <p>About 'cdemoGeneralInfo' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CdemoGeneralInfo
 * <br></p>
 * 
 * <p>About 'cdemoCustomerInfo' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CdemoCustomerInfo
 * <br></p>
 * 
 * <p>About 'cdemoAccountInfo' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CdemoAccountInfo
 * <br></p>
 * 
 * <p>About 'cdemoCardInfo' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CdemoCardInfo
 * <br></p>
 * 
 * <p>About 'cdemoMoreInfo' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CdemoMoreInfo
 * <br></p>
 * 
 * <p>About 'cdemoCb00Info' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CdemoCb00Info
 * <br></p>
 * 
 * @see RecordEntity
 */
public class CarddemoCommarea extends RecordEntity {
	 ...
	 * 
	 */
	private final Group cdemoCb00Info = new Group(root);
	private final Elementary cdemoCb00TrnidFirst = new Elementary(cdemoCb00Info,new AlphanumericType(16));
	private final Elementary cdemoCb00TrnidLast = new Elementary(cdemoCb00Info,new AlphanumericType(16));
	private final Elementary cdemoCb00PageNum = new Elementary(cdemoCb00Info,new ZonedType(8, 0, false));
	private final Elementary cdemoCb00NextPageFlg = new Elementary(cdemoCb00Info,new AlphanumericType(1),"N");
	private final ConditionName nextPageYes=new ConditionName(cdemoCb00NextPageFlg,"Y");
	private final ConditionName nextPageNo=new ConditionName(cdemoCb00NextPageFlg,"N");
	private final Elementary cdemoCb00TrnSelFlg = new Elementary(cdemoCb00Info,new AlphanumericType(1));
	private final Elementary cdemoCb00TrnSelected = new Elementary(cdemoCb00Info,new AlphanumericType(16));
	...
	/**
	 * Gets the reference for attribute cdemoCb00Info.
	 * @return the cdemoCb00Info attribute reference
	 */
	public RangeReference getCdemoCb00InfoReference() {
		return cdemoCb00Info.getReference();
	}	
				
	/**
	 * Setter for cdemoCb00Info .
	 */
   	public void setCdemoCb00Info(RangeReference reference) {
       	cdemoCb00Info.getReference().setBytes(reference.getBytes());
   	}
 
	/**
	 * Gets the reference for attribute cdemoCb00TrnidFirst.
	 * @return the cdemoCb00TrnidFirst attribute reference
	 */
	public ElementaryRangeReference getCdemoCb00TrnidFirstReference() {
		return cdemoCb00TrnidFirst.getReference();
	}

	/**
	 * Getter for cdemoCb00TrnidFirst attribute.
	 * @return cdemoCb00TrnidFirst attribute
	 */
	public String getCdemoCb00TrnidFirst() {
		return cdemoCb00TrnidFirst.getValue();
	}

	/**
	 * Setter for cdemoCb00TrnidFirst attribute.
	 * @param cdemoCb00TrnidFirst the new value of cdemoCb00TrnidFirst
	 */
	public void setCdemoCb00TrnidFirst(String cdemoCb00TrnidFirst) {
		this.cdemoCb00TrnidFirst.setValue(cdemoCb00TrnidFirst);
	}
	/**
	 * Gets the reference for attribute cdemoCb00TrnidLast.
	 * @return the cdemoCb00TrnidLast attribute reference
	 */
	public ElementaryRangeReference getCdemoCb00TrnidLastReference() {
		return cdemoCb00TrnidLast.getReference();
	}

	/**
	 * Getter for cdemoCb00TrnidLast attribute.
	 * @return cdemoCb00TrnidLast attribute
	 */
	public String getCdemoCb00TrnidLast() {
		return cdemoCb00TrnidLast.getValue();
	}

	/**
	 * Setter for cdemoCb00TrnidLast attribute.
	 * @param cdemoCb00TrnidLast the new value of cdemoCb00TrnidLast
	 */
	public void setCdemoCb00TrnidLast(String cdemoCb00TrnidLast) {
		this.cdemoCb00TrnidLast.setValue(cdemoCb00TrnidLast);
	}
	/**
	 * Gets the reference for attribute cdemoCb00PageNum.
	 * @return the cdemoCb00PageNum attribute reference
	 */
	public ElementaryRangeReference getCdemoCb00PageNumReference() {
		return cdemoCb00PageNum.getReference();
	}

	/**
	 * Getter for cdemoCb00PageNum attribute.
	 * @return cdemoCb00PageNum attribute
	 */
	public int getCdemoCb00PageNum() {
		return cdemoCb00PageNum.getValue();
	}

	/**
	 * Setter for cdemoCb00PageNum attribute.
	 * @param cdemoCb00PageNum the new value of cdemoCb00PageNum
	 */
	public void setCdemoCb00PageNum(int cdemoCb00PageNum) {
		this.cdemoCb00PageNum.setValue(cdemoCb00PageNum);
	}
	/**
	 * Gets the reference for attribute cdemoCb00NextPageFlg.
	 * @return the cdemoCb00NextPageFlg attribute reference
	 */
	public ElementaryRangeReference getCdemoCb00NextPageFlgReference() {
		return cdemoCb00NextPageFlg.getReference();
	}

	/**
	 * Getter for cdemoCb00NextPageFlg attribute.
	 * @return cdemoCb00NextPageFlg attribute
	 */
	public String getCdemoCb00NextPageFlg() {
		return cdemoCb00NextPageFlg.getValue();
	}

	/**
	 * Setter for cdemoCb00NextPageFlg attribute.
	 * @param cdemoCb00NextPageFlg the new value of cdemoCb00NextPageFlg
	 */
	public void setCdemoCb00NextPageFlg(String cdemoCb00NextPageFlg) {
		this.cdemoCb00NextPageFlg.setValue(cdemoCb00NextPageFlg);
	}
	/**
	...
	public ConditionReference getNextPageYesReference() {
		return cdemoCb00NextPageFlg.getCondition(nextPageYes);	
	}
	...
	public ConditionReference getNextPageNoReference() {
		return cdemoCb00NextPageFlg.getCondition(nextPageNo);	
	}
	...
	/**
	 * Gets the reference for attribute cdemoCb00TrnSelFlg.
	 * @return the cdemoCb00TrnSelFlg attribute reference
	 */
	public ElementaryRangeReference getCdemoCb00TrnSelFlgReference() {
		return cdemoCb00TrnSelFlg.getReference();
	}

	/**
	 * Getter for cdemoCb00TrnSelFlg attribute.
	 * @return cdemoCb00TrnSelFlg attribute
	 */
	public String getCdemoCb00TrnSelFlg() {
		return cdemoCb00TrnSelFlg.getValue();
	}

	/**
	 * Setter for cdemoCb00TrnSelFlg attribute.
	 * @param cdemoCb00TrnSelFlg the new value of cdemoCb00TrnSelFlg
	 */
	public void setCdemoCb00TrnSelFlg(String cdemoCb00TrnSelFlg) {
		this.cdemoCb00TrnSelFlg.setValue(cdemoCb00TrnSelFlg);
	}
	/**
	 * Gets the reference for attribute cdemoCb00TrnSelected.
	 * @return the cdemoCb00TrnSelected attribute reference
	 */
	public ElementaryRangeReference getCdemoCb00TrnSelectedReference() {
		return cdemoCb00TrnSelected.getReference();
	}

	/**
	 * Getter for cdemoCb00TrnSelected attribute.
	 * @return cdemoCb00TrnSelected attribute
	 */
	public String getCdemoCb00TrnSelected() {
		return cdemoCb00TrnSelected.getValue();
	}

	/**
	 * Setter for cdemoCb00TrnSelected attribute.
	 * @param cdemoCb00TrnSelected the new value of cdemoCb00TrnSelected
	 */
	public void setCdemoCb00TrnSelected(String cdemoCb00TrnSelected) {
		this.cdemoCb00TrnSelected.setValue(cdemoCb00TrnSelected);
	}
}
