 ...
 * 
 * <p>About 'cotrn2ai' field, <br>uml entity: aws.bluage.l3.workshop.cotrn02c.business.model.Cotrn2ai
 * <br></p>
 * 
 * <p>About 'cotrn2ao' field, <br>uml entity: aws.bluage.l3.workshop.cotrn02c.business.model.Cotrn2ao
 * <br></p>
 * 
 * @see RecordEntity
 */
public class Group1 extends RecordEntity {
	 ...
	 * ****************************************************************
	 */
	private final Group cotrn2ai = new Group(union);
	@SuppressWarnings("unused")
	private final Filler filler = new Filler(cotrn2ai,new AlphanumericType(12));
	private final Elementary trnnamel = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union1 = new Union(cotrn2ai);
	...
	@SuppressWarnings("unused")
	private final Filler filler1 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary trnnamei = new Elementary(cotrn2ai,new AlphanumericType(4));
	private final Elementary title01l = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union2 = new Union(cotrn2ai);
	...
	@SuppressWarnings("unused")
	private final Filler filler2 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary title01i = new Elementary(cotrn2ai,new AlphanumericType(40));
	private final Elementary curdatel = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union3 = new Union(cotrn2ai);
	...
	@SuppressWarnings("unused")
	private final Filler filler3 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary curdatei = new Elementary(cotrn2ai,new AlphanumericType(8));
	private final Elementary pgmnamel = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union4 = new Union(cotrn2ai);
	...
	@SuppressWarnings("unused")
	private final Filler filler4 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary pgmnamei = new Elementary(cotrn2ai,new AlphanumericType(8));
	private final Elementary title02l = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union5 = new Union(cotrn2ai);
	...
	@SuppressWarnings("unused")
	private final Filler filler5 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary title02i = new Elementary(cotrn2ai,new AlphanumericType(40));
	private final Elementary curtimel = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union6 = new Union(cotrn2ai);
	...
	@SuppressWarnings("unused")
	private final Filler filler6 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary curtimei = new Elementary(cotrn2ai,new AlphanumericType(8));
	private final Elementary actidinl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union7 = new Union(cotrn2ai);
	...
	@SuppressWarnings("unused")
	private final Filler filler7 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary actidini = new Elementary(cotrn2ai,new AlphanumericType(11));
	private final Elementary cardninl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union8 = new Union(cotrn2ai);
	private final Elementary cardninf = new Elementary(union8,new AlphanumericType(1));
	private final Group group7 = new Group(union8);
	private final Elementary cardnina = new Elementary(group7,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler8 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary cardnini = new Elementary(cotrn2ai,new AlphanumericType(16));
	private final Elementary ttypcdl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union9 = new Union(cotrn2ai);
	private final Elementary ttypcdf = new Elementary(union9,new AlphanumericType(1));
	private final Group group8 = new Group(union9);
	private final Elementary ttypcda = new Elementary(group8,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler9 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary ttypcdi = new Elementary(cotrn2ai,new AlphanumericType(2));
	private final Elementary tcatcdl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union10 = new Union(cotrn2ai);
	private final Elementary tcatcdf = new Elementary(union10,new AlphanumericType(1));
	private final Group group9 = new Group(union10);
	private final Elementary tcatcda = new Elementary(group9,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler10 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary tcatcdi = new Elementary(cotrn2ai,new AlphanumericType(4));
	private final Elementary trnsrcl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union11 = new Union(cotrn2ai);
	private final Elementary trnsrcf = new Elementary(union11,new AlphanumericType(1));
	private final Group group10 = new Group(union11);
	private final Elementary trnsrca = new Elementary(group10,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler11 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary trnsrci = new Elementary(cotrn2ai,new AlphanumericType(10));
	private final Elementary tdescl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union12 = new Union(cotrn2ai);
	private final Elementary tdescf = new Elementary(union12,new AlphanumericType(1));
	private final Group group11 = new Group(union12);
	private final Elementary tdesca = new Elementary(group11,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler12 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary tdesci = new Elementary(cotrn2ai,new AlphanumericType(60));
	private final Elementary trnamtl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union13 = new Union(cotrn2ai);
	private final Elementary trnamtf = new Elementary(union13,new AlphanumericType(1));
	private final Group group12 = new Group(union13);
	private final Elementary trnamta = new Elementary(group12,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler13 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary trnamti = new Elementary(cotrn2ai,new AlphanumericType(12));
	private final Elementary torigdtl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union14 = new Union(cotrn2ai);
	private final Elementary torigdtf = new Elementary(union14,new AlphanumericType(1));
	private final Group group13 = new Group(union14);
	private final Elementary torigdta = new Elementary(group13,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler14 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary torigdti = new Elementary(cotrn2ai,new AlphanumericType(10));
	private final Elementary tprocdtl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union15 = new Union(cotrn2ai);
	private final Elementary tprocdtf = new Elementary(union15,new AlphanumericType(1));
	private final Group group14 = new Group(union15);
	private final Elementary tprocdta = new Elementary(group14,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler15 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary tprocdti = new Elementary(cotrn2ai,new AlphanumericType(10));
	private final Elementary midl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union16 = new Union(cotrn2ai);
	private final Elementary midf = new Elementary(union16,new AlphanumericType(1));
	private final Group group15 = new Group(union16);
	private final Elementary mida = new Elementary(group15,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler16 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary midi = new Elementary(cotrn2ai,new AlphanumericType(9));
	private final Elementary mnamel = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union17 = new Union(cotrn2ai);
	private final Elementary mnamef = new Elementary(union17,new AlphanumericType(1));
	private final Group group16 = new Group(union17);
	private final Elementary mnamea = new Elementary(group16,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler17 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary mnamei = new Elementary(cotrn2ai,new AlphanumericType(30));
	private final Elementary mcityl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union18 = new Union(cotrn2ai);
	private final Elementary mcityf = new Elementary(union18,new AlphanumericType(1));
	private final Group group17 = new Group(union18);
	private final Elementary mcitya = new Elementary(group17,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler18 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary mcityi = new Elementary(cotrn2ai,new AlphanumericType(25));
	private final Elementary mzipl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union19 = new Union(cotrn2ai);
	private final Elementary mzipf = new Elementary(union19,new AlphanumericType(1));
	private final Group group18 = new Group(union19);
	private final Elementary mzipa = new Elementary(group18,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler19 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary mzipi = new Elementary(cotrn2ai,new AlphanumericType(10));
	private final Elementary confirml = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union20 = new Union(cotrn2ai);
	private final Elementary confirmf = new Elementary(union20,new AlphanumericType(1));
	private final Group group19 = new Group(union20);
	private final Elementary confirma = new Elementary(group19,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler20 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary confirmi = new Elementary(cotrn2ai,new AlphanumericType(1));
	private final Elementary errmsgl = new Elementary(cotrn2ai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union21 = new Union(cotrn2ai);
	...
	@SuppressWarnings("unused")
	private final Filler filler21 = new Filler(cotrn2ai,new AlphanumericType(4));
	private final Elementary errmsgi = new Elementary(cotrn2ai,new AlphanumericType(78));
	private final Group cotrn2ao = new Group(union);
	@SuppressWarnings("unused")
	private final Filler filler22 = new Filler(cotrn2ao,new AlphanumericType(12));
	@SuppressWarnings("unused")
	private final Filler filler23 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary trnnamec = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnnamep = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnnameh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnnamev = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnnameo = new Elementary(cotrn2ao,new AlphanumericType(4));
	@SuppressWarnings("unused")
	private final Filler filler24 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary title01c = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary title01p = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary title01h = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary title01v = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary title01o = new Elementary(cotrn2ao,new AlphanumericType(40));
	@SuppressWarnings("unused")
	private final Filler filler25 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary curdatec = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary curdatep = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary curdateh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary curdatev = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary curdateo = new Elementary(cotrn2ao,new AlphanumericType(8));
	@SuppressWarnings("unused")
	private final Filler filler26 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary pgmnamec = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary pgmnamep = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary pgmnameh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary pgmnamev = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary pgmnameo = new Elementary(cotrn2ao,new AlphanumericType(8));
	@SuppressWarnings("unused")
	private final Filler filler27 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary title02c = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary title02p = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary title02h = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary title02v = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary title02o = new Elementary(cotrn2ao,new AlphanumericType(40));
	@SuppressWarnings("unused")
	private final Filler filler28 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary curtimec = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary curtimep = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary curtimeh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary curtimev = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary curtimeo = new Elementary(cotrn2ao,new AlphanumericType(8));
	@SuppressWarnings("unused")
	private final Filler filler29 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary actidinc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary actidinp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary actidinh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary actidinv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary actidino = new Elementary(cotrn2ao,new AlphanumericType(11));
	@SuppressWarnings("unused")
	private final Filler filler30 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary cardninc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary cardninp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary cardninh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary cardninv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary cardnino = new Elementary(cotrn2ao,new AlphanumericType(16));
	@SuppressWarnings("unused")
	private final Filler filler31 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary ttypcdc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary ttypcdp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary ttypcdh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary ttypcdv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary ttypcdo = new Elementary(cotrn2ao,new AlphanumericType(2));
	@SuppressWarnings("unused")
	private final Filler filler32 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary tcatcdc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tcatcdp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tcatcdh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tcatcdv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tcatcdo = new Elementary(cotrn2ao,new AlphanumericType(4));
	@SuppressWarnings("unused")
	private final Filler filler33 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary trnsrcc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnsrcp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnsrch = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnsrcv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnsrco = new Elementary(cotrn2ao,new AlphanumericType(10));
	@SuppressWarnings("unused")
	private final Filler filler34 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary tdescc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tdescp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tdesch = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tdescv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tdesco = new Elementary(cotrn2ao,new AlphanumericType(60));
	@SuppressWarnings("unused")
	private final Filler filler35 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary trnamtc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnamtp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnamth = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnamtv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary trnamto = new Elementary(cotrn2ao,new AlphanumericType(12));
	@SuppressWarnings("unused")
	private final Filler filler36 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary torigdtc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary torigdtp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary torigdth = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary torigdtv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary torigdto = new Elementary(cotrn2ao,new AlphanumericType(10));
	@SuppressWarnings("unused")
	private final Filler filler37 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary tprocdtc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tprocdtp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tprocdth = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tprocdtv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary tprocdto = new Elementary(cotrn2ao,new AlphanumericType(10));
	@SuppressWarnings("unused")
	private final Filler filler38 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary midc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary midp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary midh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary midv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mido = new Elementary(cotrn2ao,new AlphanumericType(9));
	@SuppressWarnings("unused")
	private final Filler filler39 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary mnamec = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mnamep = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mnameh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mnamev = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mnameo = new Elementary(cotrn2ao,new AlphanumericType(30));
	@SuppressWarnings("unused")
	private final Filler filler40 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary mcityc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mcityp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mcityh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mcityv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mcityo = new Elementary(cotrn2ao,new AlphanumericType(25));
	@SuppressWarnings("unused")
	private final Filler filler41 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary mzipc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mzipp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mziph = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mzipv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary mzipo = new Elementary(cotrn2ao,new AlphanumericType(10));
	@SuppressWarnings("unused")
	private final Filler filler42 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary confirmc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary confirmp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary confirmh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary confirmv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary confirmo = new Elementary(cotrn2ao,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler43 = new Filler(cotrn2ao,new AlphanumericType(3));
	private final Elementary errmsgc = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary errmsgp = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary errmsgh = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary errmsgv = new Elementary(cotrn2ao,new AlphanumericType(1));
	private final Elementary errmsgo = new Elementary(cotrn2ao,new AlphanumericType(78));
	...
	/**
	 * Gets the reference for attribute cotrn2ai.
	 * @return the cotrn2ai attribute reference
	 */
	public RangeReference getCotrn2aiReference() {
		return cotrn2ai.getReference();
	}	
				
	/**
	 * Setter for cotrn2ai .
	 */
   	public void setCotrn2ai(RangeReference reference) {
       	cotrn2ai.getReference().setBytes(reference.getBytes());
   	}
	...
	/**
	 * Gets the reference for attribute cardninl.
	 * @return the cardninl attribute reference
	 */
	public ElementaryRangeReference getCardninlReference() {
		return cardninl.getReference();
	}

	/**
	 * Getter for cardninl attribute.
	 * @return cardninl attribute
	 */
	public int getCardninl() {
		return cardninl.getValue();
	}

	/**
	 * Setter for cardninl attribute.
	 * @param cardninl the new value of cardninl
	 */
	public void setCardninl(int cardninl) {
		this.cardninl.setValue(cardninl);
	}
	/**
	 * Gets the reference for attribute cardninf.
	 * @return the cardninf attribute reference
	 */
	public ElementaryRangeReference getCardninfReference() {
		return cardninf.getReference();
	}

	/**
	 * Getter for cardninf attribute.
	 * @return cardninf attribute
	 */
	public String getCardninf() {
		return cardninf.getValue();
	}

	/**
	 * Setter for cardninf attribute.
	 * @param cardninf the new value of cardninf
	 */
	public void setCardninf(String cardninf) {
		this.cardninf.setValue(cardninf);
	}
	/**
	 * Gets the reference for attribute cardnina.
	 * @return the cardnina attribute reference
	 */
	public ElementaryRangeReference getCardninaReference() {
		return cardnina.getReference();
	}

	/**
	 * Getter for cardnina attribute.
	 * @return cardnina attribute
	 */
	public String getCardnina() {
		return cardnina.getValue();
	}

	/**
	 * Setter for cardnina attribute.
	 * @param cardnina the new value of cardnina
	 */
	public void setCardnina(String cardnina) {
		this.cardnina.setValue(cardnina);
	}
	/**
	 * Gets the reference for attribute cardnini.
	 * @return the cardnini attribute reference
	 */
	public ElementaryRangeReference getCardniniReference() {
		return cardnini.getReference();
	}

	/**
	 * Getter for cardnini attribute.
	 * @return cardnini attribute
	 */
	public String getCardnini() {
		return cardnini.getValue();
	}

	/**
	 * Setter for cardnini attribute.
	 * @param cardnini the new value of cardnini
	 */
	public void setCardnini(String cardnini) {
		this.cardnini.setValue(cardnini);
	}
	/**
	...
	/**
	 * Gets the reference for attribute cotrn2ao.
	 * @return the cotrn2ao attribute reference
	 */
	public RangeReference getCotrn2aoReference() {
		return cotrn2ao.getReference();
	}	
				
	/**
	 * Setter for cotrn2ao .
	 */
   	public void setCotrn2ao(RangeReference reference) {
       	cotrn2ao.getReference().setBytes(reference.getBytes());
   	}
	...
	/**
	 * Gets the reference for attribute cardninc.
	 * @return the cardninc attribute reference
	 */
	public ElementaryRangeReference getCardnincReference() {
		return cardninc.getReference();
	}

	/**
	 * Getter for cardninc attribute.
	 * @return cardninc attribute
	 */
	public String getCardninc() {
		return cardninc.getValue();
	}

	/**
	 * Setter for cardninc attribute.
	 * @param cardninc the new value of cardninc
	 */
	public void setCardninc(String cardninc) {
		this.cardninc.setValue(cardninc);
	}
	/**
	 * Gets the reference for attribute cardninp.
	 * @return the cardninp attribute reference
	 */
	public ElementaryRangeReference getCardninpReference() {
		return cardninp.getReference();
	}

	/**
	 * Getter for cardninp attribute.
	 * @return cardninp attribute
	 */
	public String getCardninp() {
		return cardninp.getValue();
	}

	/**
	 * Setter for cardninp attribute.
	 * @param cardninp the new value of cardninp
	 */
	public void setCardninp(String cardninp) {
		this.cardninp.setValue(cardninp);
	}
	/**
	 * Gets the reference for attribute cardninh.
	 * @return the cardninh attribute reference
	 */
	public ElementaryRangeReference getCardninhReference() {
		return cardninh.getReference();
	}

	/**
	 * Getter for cardninh attribute.
	 * @return cardninh attribute
	 */
	public String getCardninh() {
		return cardninh.getValue();
	}

	/**
	 * Setter for cardninh attribute.
	 * @param cardninh the new value of cardninh
	 */
	public void setCardninh(String cardninh) {
		this.cardninh.setValue(cardninh);
	}
	/**
	 * Gets the reference for attribute cardninv.
	 * @return the cardninv attribute reference
	 */
	public ElementaryRangeReference getCardninvReference() {
		return cardninv.getReference();
	}

	/**
	 * Getter for cardninv attribute.
	 * @return cardninv attribute
	 */
	public String getCardninv() {
		return cardninv.getValue();
	}

	/**
	 * Setter for cardninv attribute.
	 * @param cardninv the new value of cardninv
	 */
	public void setCardninv(String cardninv) {
		this.cardninv.setValue(cardninv);
	}
	/**
	 * Gets the reference for attribute cardnino.
	 * @return the cardnino attribute reference
	 */
	public ElementaryRangeReference getCardninoReference() {
		return cardnino.getReference();
	}

	/**
	 * Getter for cardnino attribute.
	 * @return cardnino attribute
	 */
	public String getCardnino() {
		return cardnino.getValue();
	}

	/**
	 * Setter for cardnino attribute.
	 * @param cardnino the new value of cardnino
	 */
	public void setCardnino(String cardnino) {
		this.cardnino.setValue(cardnino);
	}
	/**
