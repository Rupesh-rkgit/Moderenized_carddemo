 ...
 * 
 * <p>About 'fdXreffileRec' field, <br>uml entity: aws.bluage.l3.workshop.cbstm03b.business.model.FdXreffileRec
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.cbstm03b.business.model.XrefFile")
@Lazy
@Scope("prototype")
public class XrefFile extends RecordEntity {
	 ...
	 */
	public XrefFile(@Qualifier("Cbstm03bContextConfiguration") Configuration configuration) {
		super(configuration);
		setupRoot(root);
	}
