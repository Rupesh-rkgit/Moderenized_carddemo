package aws.bluage.l3.workshop.cocrdlic.business.context;
import aws.bluage.l3.workshop.cocrdlic.business.model.CardRecord;
import aws.bluage.l3.workshop.cocrdlic.business.model.CarddemoCommarea;
import aws.bluage.l3.workshop.cocrdlic.business.model.CcWorkAreas;
import aws.bluage.l3.workshop.cocrdlic.business.model.CcdaCommonMessages;
import aws.bluage.l3.workshop.cocrdlic.business.model.CcdaScreenTitle;
import aws.bluage.l3.workshop.cocrdlic.business.model.Dfhaid;
import aws.bluage.l3.workshop.cocrdlic.business.model.Dfhbmsca;
import aws.bluage.l3.workshop.cocrdlic.business.model.Dfhcommarea;
import aws.bluage.l3.workshop.cocrdlic.business.model.Dfheiblk;
import aws.bluage.l3.workshop.cocrdlic.business.model.Group1;
import aws.bluage.l3.workshop.cocrdlic.business.model.SecUserData;
import aws.bluage.l3.workshop.cocrdlic.business.model.WsCommarea;
import aws.bluage.l3.workshop.cocrdlic.business.model.WsConstants;
import aws.bluage.l3.workshop.cocrdlic.business.model.WsDateTime;
import aws.bluage.l3.workshop.cocrdlic.business.model.WsMiscStorage;
import aws.bluage.l3.workshop.cocrdlic.business.model.WsThisProgcommarea;
...
/**
 * Data simplifier context CocrdlicContext.
 * 
 ...
 * </p>
 * 
 * <p>About 'wsMiscStorage' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.WsMiscStorage
 * <br></p>
 * 
 * <p>About 'wsConstants' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.WsConstants
 * <br></p>
 * 
 * <p>About 'ccWorkAreas' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.CcWorkAreas
 * <br></p>
 * 
 * <p>About 'carddemoCommarea' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.CarddemoCommarea
 * <br></p>
 * 
 * <p>About 'wsThisProgcommarea' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.WsThisProgcommarea
 * <br></p>
 * 
 * <p>About 'wsCommarea' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.WsCommarea
 * <br></p>
 * 
 * <p>About 'dfhbmsca' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.Dfhbmsca
 * <br></p>
 * 
 * <p>About 'dfhaid' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.Dfhaid
 * <br></p>
 * 
 * <p>About 'ccdaScreenTitle' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.CcdaScreenTitle
 * <br></p>
 * 
 * <p>About 'group1' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.Group1
 * <br></p>
 * 
 * <p>About 'wsDateTime' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.WsDateTime
 * <br></p>
 * 
 * <p>About 'ccdaCommonMessages' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.CcdaCommonMessages
 * <br></p>
 * 
 * <p>About 'secUserData' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.SecUserData
 * <br></p>
 * 
 * <p>About 'cardRecord' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.CardRecord
 * <br></p>
 * 
 * <p>About 'dfheiblk' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.Dfheiblk
 * <br></p>
 * 
 * <p>About 'dfhcommarea' field, <br>uml entity: aws.bluage.l3.workshop.cocrdlic.business.model.Dfhcommarea
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.cocrdlic.business.context.CocrdlicContext")
@Lazy
@Scope("prototype")
public class CocrdlicContext extends JicsRuntimeContext {
	 ...
	 */
	public CocrdlicContext (@Qualifier("CocrdlicContextConfiguration") Configuration configuration) {
		super(configuration);
	...
	/**
	 * Getter for wsConstants.
	 * @return the wsConstants
	 */
	public WsConstants getWsConstants() {
		return this.wsConstants;
	}

	/**
	 * Setter for wsConstants.
	 * @param reference the new value for wsConstants
	 */
	public void setWsConstants(RangeReference reference) {
		this.wsConstants.setBytes(reference.getBytes());
	}
	...
	private void initWorking(Configuration configuration) {
		...
		wsConstants = new WsConstants(configuration);
	...
	private void initRecordEntities() {
		recordEntities = Arrays.asList(wsMiscStorage, wsConstants, ccWorkAreas, carddemoCommarea, wsThisProgcommarea, wsCommarea, dfhbmsca, dfhaid, ccdaScreenTitle, group1, wsDateTime, ccdaCommonMessages, secUserData, cardRecord);
	}
