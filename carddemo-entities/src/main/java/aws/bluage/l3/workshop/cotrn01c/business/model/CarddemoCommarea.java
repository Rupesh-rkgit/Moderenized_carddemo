 ...
 * 
 * <p>About 'cdemoGeneralInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn01c.business.model.CdemoGeneralInfo
 * <br></p>
 * 
 * <p>About 'cdemoCustomerInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn01c.business.model.CdemoCustomerInfo
 * <br></p>
 * 
 * <p>About 'cdemoAccountInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn01c.business.model.CdemoAccountInfo
 * <br></p>
 * 
 * <p>About 'cdemoCardInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn01c.business.model.CdemoCardInfo
 * <br></p>
 * 
 * <p>About 'cdemoMoreInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn01c.business.model.CdemoMoreInfo
 * <br></p>
 * 
 * <p>About 'cdemoCt01Info' field, <br>uml entity: aws.bluage.l3.workshop.cotrn01c.business.model.CdemoCt01Info
 * <br></p>
 * 
 * @see RecordEntity
 */
public class CarddemoCommarea extends RecordEntity {
	 ...
	 * 
	 */
	private final Group cdemoCt01Info = new Group(root);
	private final Elementary cdemoCt01TrnidFirst = new Elementary(cdemoCt01Info,new AlphanumericType(16));
	private final Elementary cdemoCt01TrnidLast = new Elementary(cdemoCt01Info,new AlphanumericType(16));
	private final Elementary cdemoCt01PageNum = new Elementary(cdemoCt01Info,new ZonedType(8, 0, false));
	private final Elementary cdemoCt01NextPageFlg = new Elementary(cdemoCt01Info,new AlphanumericType(1),"N");
	private final ConditionName nextPageYes=new ConditionName(cdemoCt01NextPageFlg,"Y");
	private final ConditionName nextPageNo=new ConditionName(cdemoCt01NextPageFlg,"N");
	private final Elementary cdemoCt01TrnSelFlg = new Elementary(cdemoCt01Info,new AlphanumericType(1));
	private final Elementary cdemoCt01TrnSelected = new Elementary(cdemoCt01Info,new AlphanumericType(16));
	...
	/**
	 * Gets the reference for attribute cdemoCt01Info.
	 * @return the cdemoCt01Info attribute reference
	 */
	public RangeReference getCdemoCt01InfoReference() {
		return cdemoCt01Info.getReference();
	}	
				
	/**
	 * Setter for cdemoCt01Info .
	 */
   	public void setCdemoCt01Info(RangeReference reference) {
       	cdemoCt01Info.getReference().setBytes(reference.getBytes());
   	}
 
	/**
	 * Gets the reference for attribute cdemoCt01TrnidFirst.
	 * @return the cdemoCt01TrnidFirst attribute reference
	 */
	public ElementaryRangeReference getCdemoCt01TrnidFirstReference() {
		return cdemoCt01TrnidFirst.getReference();
	}

	/**
	 * Getter for cdemoCt01TrnidFirst attribute.
	 * @return cdemoCt01TrnidFirst attribute
	 */
	public String getCdemoCt01TrnidFirst() {
		return cdemoCt01TrnidFirst.getValue();
	}

	/**
	 * Setter for cdemoCt01TrnidFirst attribute.
	 * @param cdemoCt01TrnidFirst the new value of cdemoCt01TrnidFirst
	 */
	public void setCdemoCt01TrnidFirst(String cdemoCt01TrnidFirst) {
		this.cdemoCt01TrnidFirst.setValue(cdemoCt01TrnidFirst);
	}
	/**
	 * Gets the reference for attribute cdemoCt01TrnidLast.
	 * @return the cdemoCt01TrnidLast attribute reference
	 */
	public ElementaryRangeReference getCdemoCt01TrnidLastReference() {
		return cdemoCt01TrnidLast.getReference();
	}

	/**
	 * Getter for cdemoCt01TrnidLast attribute.
	 * @return cdemoCt01TrnidLast attribute
	 */
	public String getCdemoCt01TrnidLast() {
		return cdemoCt01TrnidLast.getValue();
	}

	/**
	 * Setter for cdemoCt01TrnidLast attribute.
	 * @param cdemoCt01TrnidLast the new value of cdemoCt01TrnidLast
	 */
	public void setCdemoCt01TrnidLast(String cdemoCt01TrnidLast) {
		this.cdemoCt01TrnidLast.setValue(cdemoCt01TrnidLast);
	}
	/**
	 * Gets the reference for attribute cdemoCt01PageNum.
	 * @return the cdemoCt01PageNum attribute reference
	 */
	public ElementaryRangeReference getCdemoCt01PageNumReference() {
		return cdemoCt01PageNum.getReference();
	}

	/**
	 * Getter for cdemoCt01PageNum attribute.
	 * @return cdemoCt01PageNum attribute
	 */
	public int getCdemoCt01PageNum() {
		return cdemoCt01PageNum.getValue();
	}

	/**
	 * Setter for cdemoCt01PageNum attribute.
	 * @param cdemoCt01PageNum the new value of cdemoCt01PageNum
	 */
	public void setCdemoCt01PageNum(int cdemoCt01PageNum) {
		this.cdemoCt01PageNum.setValue(cdemoCt01PageNum);
	}
	/**
	 * Gets the reference for attribute cdemoCt01NextPageFlg.
	 * @return the cdemoCt01NextPageFlg attribute reference
	 */
	public ElementaryRangeReference getCdemoCt01NextPageFlgReference() {
		return cdemoCt01NextPageFlg.getReference();
	}

	/**
	 * Getter for cdemoCt01NextPageFlg attribute.
	 * @return cdemoCt01NextPageFlg attribute
	 */
	public String getCdemoCt01NextPageFlg() {
		return cdemoCt01NextPageFlg.getValue();
	}

	/**
	 * Setter for cdemoCt01NextPageFlg attribute.
	 * @param cdemoCt01NextPageFlg the new value of cdemoCt01NextPageFlg
	 */
	public void setCdemoCt01NextPageFlg(String cdemoCt01NextPageFlg) {
		this.cdemoCt01NextPageFlg.setValue(cdemoCt01NextPageFlg);
	}
	/**
	...
	public ConditionReference getNextPageYesReference() {
		return cdemoCt01NextPageFlg.getCondition(nextPageYes);	
	}
	...
	public ConditionReference getNextPageNoReference() {
		return cdemoCt01NextPageFlg.getCondition(nextPageNo);	
	}
	...
	/**
	 * Gets the reference for attribute cdemoCt01TrnSelFlg.
	 * @return the cdemoCt01TrnSelFlg attribute reference
	 */
	public ElementaryRangeReference getCdemoCt01TrnSelFlgReference() {
		return cdemoCt01TrnSelFlg.getReference();
	}

	/**
	 * Getter for cdemoCt01TrnSelFlg attribute.
	 * @return cdemoCt01TrnSelFlg attribute
	 */
	public String getCdemoCt01TrnSelFlg() {
		return cdemoCt01TrnSelFlg.getValue();
	}

	/**
	 * Setter for cdemoCt01TrnSelFlg attribute.
	 * @param cdemoCt01TrnSelFlg the new value of cdemoCt01TrnSelFlg
	 */
	public void setCdemoCt01TrnSelFlg(String cdemoCt01TrnSelFlg) {
		this.cdemoCt01TrnSelFlg.setValue(cdemoCt01TrnSelFlg);
	}
	/**
	 * Gets the reference for attribute cdemoCt01TrnSelected.
	 * @return the cdemoCt01TrnSelected attribute reference
	 */
	public ElementaryRangeReference getCdemoCt01TrnSelectedReference() {
		return cdemoCt01TrnSelected.getReference();
	}

	/**
	 * Getter for cdemoCt01TrnSelected attribute.
	 * @return cdemoCt01TrnSelected attribute
	 */
	public String getCdemoCt01TrnSelected() {
		return cdemoCt01TrnSelected.getValue();
	}

	/**
	 * Setter for cdemoCt01TrnSelected attribute.
	 * @param cdemoCt01TrnSelected the new value of cdemoCt01TrnSelected
	 */
	public void setCdemoCt01TrnSelected(String cdemoCt01TrnSelected) {
		this.cdemoCt01TrnSelected.setValue(cdemoCt01TrnSelected);
	}
}
