 ...
 *  *****************************************************************<br>
 *   Program     : COMEN01C.CBL<br>
 *   Application : CardDemo<br>
 *   Type        : CICS COBOL Program<br>
 *   Function    : Main Menu for the Regular users<br>
 *  *****************************************************************<br>
...
public class WsVariables extends RecordEntity {
	...
	private final Elementary wsPgmname = new Elementary(root,new AlphanumericType(8),"COMEN01C");
	private final Elementary wsTranid = new Elementary(root,new AlphanumericType(4),"CM00");
	...
	private final Elementary wsMenuOptTxt = new Elementary(root,new AlphanumericType(40)," ");
	...
	/**
	 * Gets the reference for attribute wsMenuOptTxt.
	 * @return the wsMenuOptTxt attribute reference
	 */
	public ElementaryRangeReference getWsMenuOptTxtReference() {
		return wsMenuOptTxt.getReference();
	}

	/**
	 * Getter for wsMenuOptTxt attribute.
	 * @return wsMenuOptTxt attribute
	 */
	public String getWsMenuOptTxt() {
		return wsMenuOptTxt.getValue();
	}

	/**
	 * Setter for wsMenuOptTxt attribute.
	 * @param wsMenuOptTxt the new value of wsMenuOptTxt
	 */
	public void setWsMenuOptTxt(String wsMenuOptTxt) {
		this.wsMenuOptTxt.setValue(wsMenuOptTxt);
	}
}
