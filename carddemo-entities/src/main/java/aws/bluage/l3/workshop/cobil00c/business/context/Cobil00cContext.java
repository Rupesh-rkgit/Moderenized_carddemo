package aws.bluage.l3.workshop.cobil00c.business.context;
import aws.bluage.l3.workshop.cobil00c.business.model.AccountRecord;
import aws.bluage.l3.workshop.cobil00c.business.model.CardXrefRecord;
import aws.bluage.l3.workshop.cobil00c.business.model.CarddemoCommarea;
import aws.bluage.l3.workshop.cobil00c.business.model.CcdaCommonMessages;
import aws.bluage.l3.workshop.cobil00c.business.model.CcdaScreenTitle;
import aws.bluage.l3.workshop.cobil00c.business.model.Dfhaid;
import aws.bluage.l3.workshop.cobil00c.business.model.Dfhbmsca;
import aws.bluage.l3.workshop.cobil00c.business.model.Dfhcommarea;
import aws.bluage.l3.workshop.cobil00c.business.model.Dfheiblk;
import aws.bluage.l3.workshop.cobil00c.business.model.Group1;
import aws.bluage.l3.workshop.cobil00c.business.model.TranRecord;
import aws.bluage.l3.workshop.cobil00c.business.model.WsDateTime;
import aws.bluage.l3.workshop.cobil00c.business.model.WsVariables;
...
/**
 * Data simplifier context Cobil00cContext.
 * 
 ...
 * </p>
 * 
 * <p>About 'wsVariables' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.WsVariables
 * <br></p>
 * 
 * <p>About 'carddemoCommarea' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CarddemoCommarea
 * <br></p>
 * 
 * <p>About 'group1' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.Group1
 * <br></p>
 * 
 * <p>About 'ccdaScreenTitle' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CcdaScreenTitle
 * <br></p>
 * 
 * <p>About 'wsDateTime' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.WsDateTime
 * <br></p>
 * 
 * <p>About 'ccdaCommonMessages' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CcdaCommonMessages
 * <br></p>
 * 
 * <p>About 'accountRecord' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.AccountRecord
 * <br></p>
 * 
 * <p>About 'cardXrefRecord' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.CardXrefRecord
 * <br></p>
 * 
 * <p>About 'tranRecord' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.TranRecord
 * <br></p>
 * 
 * <p>About 'dfhaid' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.Dfhaid
 * <br></p>
 * 
 * <p>About 'dfhbmsca' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.Dfhbmsca
 * <br></p>
 * 
 * <p>About 'dfheiblk' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.Dfheiblk
 * <br></p>
 * 
 * <p>About 'dfhcommarea' field, <br>uml entity: aws.bluage.l3.workshop.cobil00c.business.model.Dfhcommarea
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.cobil00c.business.context.Cobil00cContext")
@Lazy
@Scope("prototype")
public class Cobil00cContext extends JicsRuntimeContext {
	 ...
	 */
	public Cobil00cContext (@Qualifier("Cobil00cContextConfiguration") Configuration configuration) {
		super(configuration);
	...
	private void initRecordEntities() {
		recordEntities = Arrays.asList(wsVariables, carddemoCommarea, group1, ccdaScreenTitle, wsDateTime, ccdaCommonMessages, accountRecord, cardXrefRecord, tranRecord, dfhaid, dfhbmsca);
	}
