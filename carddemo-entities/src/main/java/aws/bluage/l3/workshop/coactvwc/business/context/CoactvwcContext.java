package aws.bluage.l3.workshop.coactvwc.business.context;
import aws.bluage.l3.workshop.coactvwc.business.model.AbendData;
import aws.bluage.l3.workshop.coactvwc.business.model.AccountRecord;
import aws.bluage.l3.workshop.coactvwc.business.model.CardRecord;
import aws.bluage.l3.workshop.coactvwc.business.model.CardXrefRecord;
import aws.bluage.l3.workshop.coactvwc.business.model.CarddemoCommarea;
import aws.bluage.l3.workshop.coactvwc.business.model.CcWorkAreas;
import aws.bluage.l3.workshop.coactvwc.business.model.CcdaCommonMessages;
import aws.bluage.l3.workshop.coactvwc.business.model.CcdaScreenTitle;
import aws.bluage.l3.workshop.coactvwc.business.model.CustomerRecord;
import aws.bluage.l3.workshop.coactvwc.business.model.Dfhaid;
import aws.bluage.l3.workshop.coactvwc.business.model.Dfhbmsca;
import aws.bluage.l3.workshop.coactvwc.business.model.Dfhcommarea;
import aws.bluage.l3.workshop.coactvwc.business.model.Dfheiblk;
import aws.bluage.l3.workshop.coactvwc.business.model.Group1;
import aws.bluage.l3.workshop.coactvwc.business.model.SecUserData;
import aws.bluage.l3.workshop.coactvwc.business.model.WsCommarea;
import aws.bluage.l3.workshop.coactvwc.business.model.WsDateTime;
import aws.bluage.l3.workshop.coactvwc.business.model.WsLiterals;
import aws.bluage.l3.workshop.coactvwc.business.model.WsMiscStorage;
import aws.bluage.l3.workshop.coactvwc.business.model.WsThisProgcommarea;
...
/**
 * Data simplifier context CoactvwcContext.
 * 
 ...
 * </p>
 * 
 * <p>About 'wsMiscStorage' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.WsMiscStorage
 * <br></p>
 * 
 * <p>About 'wsLiterals' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.WsLiterals
 * <br></p>
 * 
 * <p>About 'ccWorkAreas' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.CcWorkAreas
 * <br></p>
 * 
 * <p>About 'carddemoCommarea' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.CarddemoCommarea
 * <br></p>
 * 
 * <p>About 'wsThisProgcommarea' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.WsThisProgcommarea
 * <br></p>
 * 
 * <p>About 'wsCommarea' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.WsCommarea
 * <br></p>
 * 
 * <p>About 'dfhbmsca' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.Dfhbmsca
 * <br></p>
 * 
 * <p>About 'dfhaid' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.Dfhaid
 * <br></p>
 * 
 * <p>About 'ccdaScreenTitle' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.CcdaScreenTitle
 * <br></p>
 * 
 * <p>About 'group1' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.Group1
 * <br></p>
 * 
 * <p>About 'wsDateTime' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.WsDateTime
 * <br></p>
 * 
 * <p>About 'ccdaCommonMessages' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.CcdaCommonMessages
 * <br></p>
 * 
 * <p>About 'abendData' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.AbendData
 * <br></p>
 * 
 * <p>About 'secUserData' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.SecUserData
 * <br></p>
 * 
 * <p>About 'accountRecord' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.AccountRecord
 * <br></p>
 * 
 * <p>About 'cardRecord' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.CardRecord
 * <br></p>
 * 
 * <p>About 'cardXrefRecord' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.CardXrefRecord
 * <br></p>
 * 
 * <p>About 'customerRecord' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.CustomerRecord
 * <br></p>
 * 
 * <p>About 'dfheiblk' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.Dfheiblk
 * <br></p>
 * 
 * <p>About 'dfhcommarea' field, <br>uml entity: aws.bluage.l3.workshop.coactvwc.business.model.Dfhcommarea
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.coactvwc.business.context.CoactvwcContext")
@Lazy
@Scope("prototype")
public class CoactvwcContext extends JicsRuntimeContext {
	 ...
	 */
	public CoactvwcContext (@Qualifier("CoactvwcContextConfiguration") Configuration configuration) {
		super(configuration);
	...
	private void initRecordEntities() {
		recordEntities = Arrays.asList(wsMiscStorage, wsLiterals, ccWorkAreas, carddemoCommarea, wsThisProgcommarea, wsCommarea, dfhbmsca, dfhaid, ccdaScreenTitle, group1, wsDateTime, ccdaCommonMessages, abendData, secUserData, accountRecord, cardRecord, cardXrefRecord, customerRecord);
	}
