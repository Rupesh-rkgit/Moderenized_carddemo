 ...
 *  *****************************************************************<br>
 *   Program     : COSGN00C.CBL<br>
 *   Application : CardDemo<br>
 *   Type        : CICS COBOL Program<br>
 *   Function    : Signon Screen for the CardDemo Application<br>
 *  *****************************************************************<br>
 ...
 * </p>
 * 
 * <p>About 'wsUserId' field, <br>
 * </p>
 * 
 * <p>About 'wsUserPwd' field, <br>
 * </p>
 * 
 * @see RecordEntity
 */
public class WsVariables extends RecordEntity {
	...
	private final Elementary wsPgmname = new Elementary(root,new AlphanumericType(8),"COSGN00C");
	private final Elementary wsTranid = new Elementary(root,new AlphanumericType(4),"CC00");
	...
	private final Elementary wsUserId = new Elementary(root,new AlphanumericType(8));
	private final Elementary wsUserPwd = new Elementary(root,new AlphanumericType(8));
	...
	/**
	 * Gets the reference for attribute wsUserId.
	 * @return the wsUserId attribute reference
	 */
	public ElementaryRangeReference getWsUserIdReference() {
		return wsUserId.getReference();
	}

	/**
	 * Getter for wsUserId attribute.
	 * @return wsUserId attribute
	 */
	public String getWsUserId() {
		return wsUserId.getValue();
	}

	/**
	 * Setter for wsUserId attribute.
	 * @param wsUserId the new value of wsUserId
	 */
	public void setWsUserId(String wsUserId) {
		this.wsUserId.setValue(wsUserId);
	}
	/**
	 * Gets the reference for attribute wsUserPwd.
	 * @return the wsUserPwd attribute reference
	 */
	public ElementaryRangeReference getWsUserPwdReference() {
		return wsUserPwd.getReference();
	}

	/**
	 * Getter for wsUserPwd attribute.
	 * @return wsUserPwd attribute
	 */
	public String getWsUserPwd() {
		return wsUserPwd.getValue();
	}

	/**
	 * Setter for wsUserPwd attribute.
	 * @param wsUserPwd the new value of wsUserPwd
	 */
	public void setWsUserPwd(String wsUserPwd) {
		this.wsUserPwd.setValue(wsUserPwd);
	}
}
