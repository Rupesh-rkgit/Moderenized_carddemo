...
import aws.bluage.l3.workshop.cosgn00c.business.model.CarddemoCommarea;
import aws.bluage.l3.workshop.cosgn00c.business.model.CcdaCommonMessages;
import aws.bluage.l3.workshop.cosgn00c.business.model.CcdaScreenTitle;
import aws.bluage.l3.workshop.cosgn00c.business.model.Dfhaid;
import aws.bluage.l3.workshop.cosgn00c.business.model.Dfhbmsca;
import aws.bluage.l3.workshop.cosgn00c.business.model.Dfhcommarea;
import aws.bluage.l3.workshop.cosgn00c.business.model.Dfheiblk;
import aws.bluage.l3.workshop.cosgn00c.business.model.Group1;
import aws.bluage.l3.workshop.cosgn00c.business.model.LogData;
import aws.bluage.l3.workshop.cosgn00c.business.model.SecUserData;
import aws.bluage.l3.workshop.cosgn00c.business.model.Sqlca;
import aws.bluage.l3.workshop.cosgn00c.business.model.WsDateTime;
import aws.bluage.l3.workshop.cosgn00c.business.model.WsVariables;
...
/**
 * Data simplifier context Cosgn00cContext.
 * 
 ...
 * </p>
 * 
 * <p>About 'wsVariables' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.WsVariables
 * <br></p>
 * 
 * <p>About 'carddemoCommarea' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.CarddemoCommarea
 * <br></p>
 * 
 * <p>About 'group1' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.Group1
 * <br></p>
 * 
 * <p>About 'ccdaScreenTitle' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.CcdaScreenTitle
 * <br></p>
 * 
 * <p>About 'wsDateTime' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.WsDateTime
 * <br></p>
 * 
 * <p>About 'ccdaCommonMessages' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.CcdaCommonMessages
 * <br></p>
 * 
 * <p>About 'secUserData' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.SecUserData
 * <br></p>
 * 
 * <p>About 'dfhaid' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.Dfhaid
 * <br></p>
 * 
 * <p>About 'dfhbmsca' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.Dfhbmsca
 * <br></p>
 * 
 * <p>About 'sqlca' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.Sqlca
 * <br></p>
 * 
 * <p>About 'logData' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.LogData
 * <br></p>
 * 
 * <p>About 'dfheiblk' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.Dfheiblk
 * <br></p>
 * 
 * <p>About 'dfhcommarea' field, <br>uml entity: aws.bluage.l3.workshop.cosgn00c.business.model.Dfhcommarea
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.cosgn00c.business.context.Cosgn00cContext")
@Lazy
@Scope("prototype")
public class Cosgn00cContext extends JicsRuntimeContext {
	 ...
	 */
	public Cosgn00cContext (@Qualifier("Cosgn00cContextConfiguration") Configuration configuration) {
		super(configuration);
	...
	/**
	 * Setter for logData.
	 * @param reference the new value for logData
	 */
	public void setLogData(RangeReference reference) {
		this.logData.setBytes(reference.getBytes());
	}
	...
	private void initWorking(Configuration configuration) {
		...
		logData = new LogData(configuration);
	}
	...
	private void initRecordEntities() {
		recordEntities = Arrays.asList(wsVariables, carddemoCommarea, group1, ccdaScreenTitle, wsDateTime, ccdaCommonMessages, secUserData, dfhaid, dfhbmsca, sqlca, logData);
	}
