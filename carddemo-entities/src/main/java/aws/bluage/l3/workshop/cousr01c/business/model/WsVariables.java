 ...
 *  *****************************************************************<br>
 *   Program     : COUSR01C.CBL<br>
 *   Application : CardDemo<br>
 *   Type        : CICS COBOL Program<br>
 *   Function    : Add a new Regular/Admin user to USRSEC file<br>
 *  *****************************************************************<br>
...
public class WsVariables extends RecordEntity {
	...
	private final Elementary wsPgmname = new Elementary(root,new AlphanumericType(8),"COUSR01C");
	private final Elementary wsTranid = new Elementary(root,new AlphanumericType(4),"CU01");
