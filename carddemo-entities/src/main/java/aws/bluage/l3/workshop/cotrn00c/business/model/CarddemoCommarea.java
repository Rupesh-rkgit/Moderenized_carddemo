 ...
 * 
 * <p>About 'cdemoGeneralInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn00c.business.model.CdemoGeneralInfo
 * <br></p>
 * 
 * <p>About 'cdemoCustomerInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn00c.business.model.CdemoCustomerInfo
 * <br></p>
 * 
 * <p>About 'cdemoAccountInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn00c.business.model.CdemoAccountInfo
 * <br></p>
 * 
 * <p>About 'cdemoCardInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn00c.business.model.CdemoCardInfo
 * <br></p>
 * 
 * <p>About 'cdemoMoreInfo' field, <br>uml entity: aws.bluage.l3.workshop.cotrn00c.business.model.CdemoMoreInfo
 * <br></p>
 * 
 * <p>About 'cdemoCt00Info' field, <br>uml entity: aws.bluage.l3.workshop.cotrn00c.business.model.CdemoCt00Info
 * <br></p>
 * 
 * @see RecordEntity
 */
public class CarddemoCommarea extends RecordEntity {
	 ...
	 * 
	 */
	private final Group cdemoCt00Info = new Group(root);
	private final Elementary cdemoCt00TrnidFirst = new Elementary(cdemoCt00Info,new AlphanumericType(16));
	private final Elementary cdemoCt00TrnidLast = new Elementary(cdemoCt00Info,new AlphanumericType(16));
	private final Elementary cdemoCt00PageNum = new Elementary(cdemoCt00Info,new ZonedType(8, 0, false));
	private final Elementary cdemoCt00NextPageFlg = new Elementary(cdemoCt00Info,new AlphanumericType(1),"N");
	private final ConditionName nextPageYes=new ConditionName(cdemoCt00NextPageFlg,"Y");
	private final ConditionName nextPageNo=new ConditionName(cdemoCt00NextPageFlg,"N");
	private final Elementary cdemoCt00TrnSelFlg = new Elementary(cdemoCt00Info,new AlphanumericType(1));
	private final Elementary cdemoCt00TrnSelected = new Elementary(cdemoCt00Info,new AlphanumericType(16));
	...
	/**
	 * Gets the reference for attribute cdemoCt00Info.
	 * @return the cdemoCt00Info attribute reference
	 */
	public RangeReference getCdemoCt00InfoReference() {
		return cdemoCt00Info.getReference();
	}	
				
	/**
	 * Setter for cdemoCt00Info .
	 */
   	public void setCdemoCt00Info(RangeReference reference) {
       	cdemoCt00Info.getReference().setBytes(reference.getBytes());
   	}
 
	/**
	 * Gets the reference for attribute cdemoCt00TrnidFirst.
	 * @return the cdemoCt00TrnidFirst attribute reference
	 */
	public ElementaryRangeReference getCdemoCt00TrnidFirstReference() {
		return cdemoCt00TrnidFirst.getReference();
	}

	/**
	 * Getter for cdemoCt00TrnidFirst attribute.
	 * @return cdemoCt00TrnidFirst attribute
	 */
	public String getCdemoCt00TrnidFirst() {
		return cdemoCt00TrnidFirst.getValue();
	}

	/**
	 * Setter for cdemoCt00TrnidFirst attribute.
	 * @param cdemoCt00TrnidFirst the new value of cdemoCt00TrnidFirst
	 */
	public void setCdemoCt00TrnidFirst(String cdemoCt00TrnidFirst) {
		this.cdemoCt00TrnidFirst.setValue(cdemoCt00TrnidFirst);
	}
	/**
	 * Gets the reference for attribute cdemoCt00TrnidLast.
	 * @return the cdemoCt00TrnidLast attribute reference
	 */
	public ElementaryRangeReference getCdemoCt00TrnidLastReference() {
		return cdemoCt00TrnidLast.getReference();
	}

	/**
	 * Getter for cdemoCt00TrnidLast attribute.
	 * @return cdemoCt00TrnidLast attribute
	 */
	public String getCdemoCt00TrnidLast() {
		return cdemoCt00TrnidLast.getValue();
	}

	/**
	 * Setter for cdemoCt00TrnidLast attribute.
	 * @param cdemoCt00TrnidLast the new value of cdemoCt00TrnidLast
	 */
	public void setCdemoCt00TrnidLast(String cdemoCt00TrnidLast) {
		this.cdemoCt00TrnidLast.setValue(cdemoCt00TrnidLast);
	}
	/**
	 * Gets the reference for attribute cdemoCt00PageNum.
	 * @return the cdemoCt00PageNum attribute reference
	 */
	public ElementaryRangeReference getCdemoCt00PageNumReference() {
		return cdemoCt00PageNum.getReference();
	}

	/**
	 * Getter for cdemoCt00PageNum attribute.
	 * @return cdemoCt00PageNum attribute
	 */
	public int getCdemoCt00PageNum() {
		return cdemoCt00PageNum.getValue();
	}

	/**
	 * Setter for cdemoCt00PageNum attribute.
	 * @param cdemoCt00PageNum the new value of cdemoCt00PageNum
	 */
	public void setCdemoCt00PageNum(int cdemoCt00PageNum) {
		this.cdemoCt00PageNum.setValue(cdemoCt00PageNum);
	}
	/**
	 * Gets the reference for attribute cdemoCt00NextPageFlg.
	 * @return the cdemoCt00NextPageFlg attribute reference
	 */
	public ElementaryRangeReference getCdemoCt00NextPageFlgReference() {
		return cdemoCt00NextPageFlg.getReference();
	}

	/**
	 * Getter for cdemoCt00NextPageFlg attribute.
	 * @return cdemoCt00NextPageFlg attribute
	 */
	public String getCdemoCt00NextPageFlg() {
		return cdemoCt00NextPageFlg.getValue();
	}

	/**
	 * Setter for cdemoCt00NextPageFlg attribute.
	 * @param cdemoCt00NextPageFlg the new value of cdemoCt00NextPageFlg
	 */
	public void setCdemoCt00NextPageFlg(String cdemoCt00NextPageFlg) {
		this.cdemoCt00NextPageFlg.setValue(cdemoCt00NextPageFlg);
	}
	/**
	...
	public ConditionReference getNextPageYesReference() {
		return cdemoCt00NextPageFlg.getCondition(nextPageYes);	
	}
	...
	public ConditionReference getNextPageNoReference() {
		return cdemoCt00NextPageFlg.getCondition(nextPageNo);	
	}
	...
	/**
	 * Gets the reference for attribute cdemoCt00TrnSelFlg.
	 * @return the cdemoCt00TrnSelFlg attribute reference
	 */
	public ElementaryRangeReference getCdemoCt00TrnSelFlgReference() {
		return cdemoCt00TrnSelFlg.getReference();
	}

	/**
	 * Getter for cdemoCt00TrnSelFlg attribute.
	 * @return cdemoCt00TrnSelFlg attribute
	 */
	public String getCdemoCt00TrnSelFlg() {
		return cdemoCt00TrnSelFlg.getValue();
	}

	/**
	 * Setter for cdemoCt00TrnSelFlg attribute.
	 * @param cdemoCt00TrnSelFlg the new value of cdemoCt00TrnSelFlg
	 */
	public void setCdemoCt00TrnSelFlg(String cdemoCt00TrnSelFlg) {
		this.cdemoCt00TrnSelFlg.setValue(cdemoCt00TrnSelFlg);
	}
	/**
	 * Gets the reference for attribute cdemoCt00TrnSelected.
	 * @return the cdemoCt00TrnSelected attribute reference
	 */
	public ElementaryRangeReference getCdemoCt00TrnSelectedReference() {
		return cdemoCt00TrnSelected.getReference();
	}

	/**
	 * Getter for cdemoCt00TrnSelected attribute.
	 * @return cdemoCt00TrnSelected attribute
	 */
	public String getCdemoCt00TrnSelected() {
		return cdemoCt00TrnSelected.getValue();
	}

	/**
	 * Setter for cdemoCt00TrnSelected attribute.
	 * @param cdemoCt00TrnSelected the new value of cdemoCt00TrnSelected
	 */
	public void setCdemoCt00TrnSelected(String cdemoCt00TrnSelected) {
		this.cdemoCt00TrnSelected.setValue(cdemoCt00TrnSelected);
	}
}
