 ...
 *  *****************************************************************<br>
 *   Program     : COADM01C.CBL<br>
 *   Application : CardDemo<br>
 *   Type        : CICS COBOL Program<br>
 *   Function    : Admin Menu for Admin users<br>
 *  *****************************************************************<br>
 ...
 * </p>
 * 
 * <p>About 'wsOptionX' field, <br>
 * </p>
 * 
 * <p>About 'wsOption' field, <br>
 * </p>
 * 
 * <p>About 'wsIdx' field, <br>
 * </p>
 * 
 * <p>About 'wsAdminOptTxt' field, <br>
 * </p>
 * 
 * @see RecordEntity
 */
public class WsVariables extends RecordEntity {
	...
	private final Elementary wsPgmname = new Elementary(root,new AlphanumericType(8),"COADM01C");
	private final Elementary wsTranid = new Elementary(root,new AlphanumericType(4),"CA00");
	...
	private final Elementary wsOptionX = new Elementary(root,new AlphanumericType(2, true));
	private final Elementary wsOption = new Elementary(root,new ZonedType(2, 0, false),Short.valueOf("0"));
	private final Elementary wsIdx = new Elementary(root,new BinaryType(4, 0, "STD", false, false, true),Short.valueOf("0"));
	private final Elementary wsAdminOptTxt = new Elementary(root,new AlphanumericType(40)," ");
	...
	/**
	 * Gets the reference for attribute wsOptionX.
	 * @return the wsOptionX attribute reference
	 */
	public ElementaryRangeReference getWsOptionXReference() {
		return wsOptionX.getReference();
	}

	/**
	 * Getter for wsOptionX attribute.
	 * @return wsOptionX attribute
	 */
	public String getWsOptionX() {
		return wsOptionX.getValue();
	}

	/**
	 * Setter for wsOptionX attribute.
	 * @param wsOptionX the new value of wsOptionX
	 */
	public void setWsOptionX(String wsOptionX) {
		this.wsOptionX.setValue(wsOptionX);
	}
	/**
	 * Gets the reference for attribute wsOption.
	 * @return the wsOption attribute reference
	 */
	public ElementaryRangeReference getWsOptionReference() {
		return wsOption.getReference();
	}

	/**
	 * Getter for wsOption attribute.
	 * @return wsOption attribute
	 */
	public int getWsOption() {
		return wsOption.getValue();
	}

	/**
	 * Setter for wsOption attribute.
	 * @param wsOption the new value of wsOption
	 */
	public void setWsOption(int wsOption) {
		this.wsOption.setValue(wsOption);
	}
	/**
	...
	/**
	 * Gets the reference for attribute wsAdminOptTxt.
	 * @return the wsAdminOptTxt attribute reference
	 */
	public ElementaryRangeReference getWsAdminOptTxtReference() {
		return wsAdminOptTxt.getReference();
	}

	/**
	 * Getter for wsAdminOptTxt attribute.
	 * @return wsAdminOptTxt attribute
	 */
	public String getWsAdminOptTxt() {
		return wsAdminOptTxt.getValue();
	}

	/**
	 * Setter for wsAdminOptTxt attribute.
	 * @param wsAdminOptTxt the new value of wsAdminOptTxt
	 */
	public void setWsAdminOptTxt(String wsAdminOptTxt) {
		this.wsAdminOptTxt.setValue(wsAdminOptTxt);
	}
}
