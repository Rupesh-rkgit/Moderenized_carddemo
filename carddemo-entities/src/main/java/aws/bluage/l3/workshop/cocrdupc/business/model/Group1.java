 ...
 * 
 * <p>About 'ccrdupai' field, <br>uml entity: aws.bluage.l3.workshop.cocrdupc.business.model.Ccrdupai
 * <br></p>
 * 
 * <p>About 'ccrdupao' field, <br>uml entity: aws.bluage.l3.workshop.cocrdupc.business.model.Ccrdupao
 * <br></p>
 * 
 * @see RecordEntity
 */
public class Group1 extends RecordEntity {
	 ...
	 * ****************************************************************
	 */
	private final Group ccrdupai = new Group(union);
	@SuppressWarnings("unused")
	private final Filler filler = new Filler(ccrdupai,new AlphanumericType(12));
	private final Elementary trnnamel = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union1 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler1 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary trnnamei = new Elementary(ccrdupai,new AlphanumericType(4));
	private final Elementary title01l = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union2 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler2 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary title01i = new Elementary(ccrdupai,new AlphanumericType(40));
	private final Elementary curdatel = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union3 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler3 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary curdatei = new Elementary(ccrdupai,new AlphanumericType(8));
	private final Elementary pgmnamel = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union4 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler4 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary pgmnamei = new Elementary(ccrdupai,new AlphanumericType(8));
	private final Elementary title02l = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union5 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler5 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary title02i = new Elementary(ccrdupai,new AlphanumericType(40));
	private final Elementary curtimel = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union6 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler6 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary curtimei = new Elementary(ccrdupai,new AlphanumericType(8));
	private final Elementary acctsidl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union7 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler7 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary acctsidi = new Elementary(ccrdupai,new AlphanumericType(11));
	private final Elementary cardsidl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union8 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler8 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary cardsidi = new Elementary(ccrdupai,new AlphanumericType(16));
	private final Elementary crdnamel = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union9 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler9 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary crdnamei = new Elementary(ccrdupai,new AlphanumericType(50));
	private final Elementary crdstcdl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union10 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler10 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary crdstcdi = new Elementary(ccrdupai,new AlphanumericType(1));
	private final Elementary expmonl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union11 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler11 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary expmoni = new Elementary(ccrdupai,new AlphanumericType(2));
	private final Elementary expyearl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union12 = new Union(ccrdupai);
	...
	@SuppressWarnings("unused")
	private final Filler filler12 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary expyeari = new Elementary(ccrdupai,new AlphanumericType(4));
	private final Elementary expdayl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union13 = new Union(ccrdupai);
	private final Elementary expdayf = new Elementary(union13,new AlphanumericType(1));
	private final Group group12 = new Group(union13);
	private final Elementary expdaya = new Elementary(group12,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler13 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary expdayi = new Elementary(ccrdupai,new AlphanumericType(2));
	private final Elementary infomsgl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union14 = new Union(ccrdupai);
	private final Elementary infomsgf = new Elementary(union14,new AlphanumericType(1));
	private final Group group13 = new Group(union14);
	private final Elementary infomsga = new Elementary(group13,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler14 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary infomsgi = new Elementary(ccrdupai,new AlphanumericType(40));
	private final Elementary errmsgl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union15 = new Union(ccrdupai);
	private final Elementary errmsgf = new Elementary(union15,new AlphanumericType(1));
	private final Group group14 = new Group(union15);
	private final Elementary errmsga = new Elementary(group14,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler15 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary errmsgi = new Elementary(ccrdupai,new AlphanumericType(80));
	private final Elementary fkeysl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union16 = new Union(ccrdupai);
	private final Elementary fkeysf = new Elementary(union16,new AlphanumericType(1));
	private final Group group15 = new Group(union16);
	private final Elementary fkeysa = new Elementary(group15,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler16 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary fkeysi = new Elementary(ccrdupai,new AlphanumericType(21));
	private final Elementary fkeyscl = new Elementary(ccrdupai,new BinaryType(4, 0, "STD", false, false, true));
	private final Union union17 = new Union(ccrdupai);
	private final Elementary fkeyscf = new Elementary(union17,new AlphanumericType(1));
	private final Group group16 = new Group(union17);
	private final Elementary fkeysca = new Elementary(group16,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler17 = new Filler(ccrdupai,new AlphanumericType(4));
	private final Elementary fkeysci = new Elementary(ccrdupai,new AlphanumericType(18));
	private final Group ccrdupao = new Group(union);
	@SuppressWarnings("unused")
	private final Filler filler18 = new Filler(ccrdupao,new AlphanumericType(12));
	@SuppressWarnings("unused")
	private final Filler filler19 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary trnnamec = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary trnnamep = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary trnnameh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary trnnamev = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary trnnameo = new Elementary(ccrdupao,new AlphanumericType(4));
	@SuppressWarnings("unused")
	private final Filler filler20 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary title01c = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary title01p = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary title01h = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary title01v = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary title01o = new Elementary(ccrdupao,new AlphanumericType(40));
	@SuppressWarnings("unused")
	private final Filler filler21 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary curdatec = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary curdatep = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary curdateh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary curdatev = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary curdateo = new Elementary(ccrdupao,new AlphanumericType(8));
	@SuppressWarnings("unused")
	private final Filler filler22 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary pgmnamec = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary pgmnamep = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary pgmnameh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary pgmnamev = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary pgmnameo = new Elementary(ccrdupao,new AlphanumericType(8));
	@SuppressWarnings("unused")
	private final Filler filler23 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary title02c = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary title02p = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary title02h = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary title02v = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary title02o = new Elementary(ccrdupao,new AlphanumericType(40));
	@SuppressWarnings("unused")
	private final Filler filler24 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary curtimec = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary curtimep = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary curtimeh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary curtimev = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary curtimeo = new Elementary(ccrdupao,new AlphanumericType(8));
	@SuppressWarnings("unused")
	private final Filler filler25 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary acctsidc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary acctsidp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary acctsidh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary acctsidv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary acctsido = new Elementary(ccrdupao,new AlphanumericType(11));
	@SuppressWarnings("unused")
	private final Filler filler26 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary cardsidc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary cardsidp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary cardsidh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary cardsidv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary cardsido = new Elementary(ccrdupao,new AlphanumericType(16));
	@SuppressWarnings("unused")
	private final Filler filler27 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary crdnamec = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary crdnamep = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary crdnameh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary crdnamev = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary crdnameo = new Elementary(ccrdupao,new AlphanumericType(50));
	@SuppressWarnings("unused")
	private final Filler filler28 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary crdstcdc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary crdstcdp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary crdstcdh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary crdstcdv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary crdstcdo = new Elementary(ccrdupao,new AlphanumericType(1));
	@SuppressWarnings("unused")
	private final Filler filler29 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary expmonc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expmonp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expmonh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expmonv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expmono = new Elementary(ccrdupao,new AlphanumericType(2));
	@SuppressWarnings("unused")
	private final Filler filler30 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary expyearc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expyearp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expyearh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expyearv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expyearo = new Elementary(ccrdupao,new AlphanumericType(4));
	@SuppressWarnings("unused")
	private final Filler filler31 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary expdayc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expdayp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expdayh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expdayv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary expdayo = new Elementary(ccrdupao,new AlphanumericType(2));
	@SuppressWarnings("unused")
	private final Filler filler32 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary infomsgc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary infomsgp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary infomsgh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary infomsgv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary infomsgo = new Elementary(ccrdupao,new AlphanumericType(40));
	@SuppressWarnings("unused")
	private final Filler filler33 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary errmsgc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary errmsgp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary errmsgh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary errmsgv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary errmsgo = new Elementary(ccrdupao,new AlphanumericType(80));
	@SuppressWarnings("unused")
	private final Filler filler34 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary fkeysc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary fkeysp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary fkeysh = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary fkeysv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary fkeyso = new Elementary(ccrdupao,new AlphanumericType(21));
	@SuppressWarnings("unused")
	private final Filler filler35 = new Filler(ccrdupao,new AlphanumericType(3));
	private final Elementary fkeyscc = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary fkeyscp = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary fkeysch = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary fkeyscv = new Elementary(ccrdupao,new AlphanumericType(1));
	private final Elementary fkeysco = new Elementary(ccrdupao,new AlphanumericType(18));
	...
	/**
	 * Gets the reference for attribute ccrdupai.
	 * @return the ccrdupai attribute reference
	 */
	public RangeReference getCcrdupaiReference() {
		return ccrdupai.getReference();
	}	
				
	/**
	 * Setter for ccrdupai .
	 */
   	public void setCcrdupai(RangeReference reference) {
       	ccrdupai.getReference().setBytes(reference.getBytes());
   	}
	...
	/**
	 * Gets the reference for attribute fkeyscl.
	 * @return the fkeyscl attribute reference
	 */
	public ElementaryRangeReference getFkeysclReference() {
		return fkeyscl.getReference();
	}

	/**
	 * Getter for fkeyscl attribute.
	 * @return fkeyscl attribute
	 */
	public int getFkeyscl() {
		return fkeyscl.getValue();
	}

	/**
	 * Setter for fkeyscl attribute.
	 * @param fkeyscl the new value of fkeyscl
	 */
	public void setFkeyscl(int fkeyscl) {
		this.fkeyscl.setValue(fkeyscl);
	}
	/**
	 * Gets the reference for attribute fkeyscf.
	 * @return the fkeyscf attribute reference
	 */
	public ElementaryRangeReference getFkeyscfReference() {
		return fkeyscf.getReference();
	}

	/**
	 * Getter for fkeyscf attribute.
	 * @return fkeyscf attribute
	 */
	public String getFkeyscf() {
		return fkeyscf.getValue();
	}

	/**
	 * Setter for fkeyscf attribute.
	 * @param fkeyscf the new value of fkeyscf
	 */
	public void setFkeyscf(String fkeyscf) {
		this.fkeyscf.setValue(fkeyscf);
	}
	/**
	 * Gets the reference for attribute fkeysca.
	 * @return the fkeysca attribute reference
	 */
	public ElementaryRangeReference getFkeyscaReference() {
		return fkeysca.getReference();
	}

	/**
	 * Getter for fkeysca attribute.
	 * @return fkeysca attribute
	 */
	public String getFkeysca() {
		return fkeysca.getValue();
	}

	/**
	 * Setter for fkeysca attribute.
	 * @param fkeysca the new value of fkeysca
	 */
	public void setFkeysca(String fkeysca) {
		this.fkeysca.setValue(fkeysca);
	}
	/**
	 * Gets the reference for attribute fkeysci.
	 * @return the fkeysci attribute reference
	 */
	public ElementaryRangeReference getFkeysciReference() {
		return fkeysci.getReference();
	}

	/**
	 * Getter for fkeysci attribute.
	 * @return fkeysci attribute
	 */
	public String getFkeysci() {
		return fkeysci.getValue();
	}

	/**
	 * Setter for fkeysci attribute.
	 * @param fkeysci the new value of fkeysci
	 */
	public void setFkeysci(String fkeysci) {
		this.fkeysci.setValue(fkeysci);
	}
	
	/**
	 * Gets the reference for attribute ccrdupao.
	 * @return the ccrdupao attribute reference
	 */
	public RangeReference getCcrdupaoReference() {
		return ccrdupao.getReference();
	}	
				
	/**
	 * Setter for ccrdupao .
	 */
   	public void setCcrdupao(RangeReference reference) {
       	ccrdupao.getReference().setBytes(reference.getBytes());
   	}
	...
	/**
	 * Gets the reference for attribute fkeyscc.
	 * @return the fkeyscc attribute reference
	 */
	public ElementaryRangeReference getFkeysccReference() {
		return fkeyscc.getReference();
	}

	/**
	 * Getter for fkeyscc attribute.
	 * @return fkeyscc attribute
	 */
	public String getFkeyscc() {
		return fkeyscc.getValue();
	}

	/**
	 * Setter for fkeyscc attribute.
	 * @param fkeyscc the new value of fkeyscc
	 */
	public void setFkeyscc(String fkeyscc) {
		this.fkeyscc.setValue(fkeyscc);
	}
	/**
	 * Gets the reference for attribute fkeyscp.
	 * @return the fkeyscp attribute reference
	 */
	public ElementaryRangeReference getFkeyscpReference() {
		return fkeyscp.getReference();
	}

	/**
	 * Getter for fkeyscp attribute.
	 * @return fkeyscp attribute
	 */
	public String getFkeyscp() {
		return fkeyscp.getValue();
	}

	/**
	 * Setter for fkeyscp attribute.
	 * @param fkeyscp the new value of fkeyscp
	 */
	public void setFkeyscp(String fkeyscp) {
		this.fkeyscp.setValue(fkeyscp);
	}
	/**
	 * Gets the reference for attribute fkeysch.
	 * @return the fkeysch attribute reference
	 */
	public ElementaryRangeReference getFkeyschReference() {
		return fkeysch.getReference();
	}

	/**
	 * Getter for fkeysch attribute.
	 * @return fkeysch attribute
	 */
	public String getFkeysch() {
		return fkeysch.getValue();
	}

	/**
	 * Setter for fkeysch attribute.
	 * @param fkeysch the new value of fkeysch
	 */
	public void setFkeysch(String fkeysch) {
		this.fkeysch.setValue(fkeysch);
	}
	/**
	 * Gets the reference for attribute fkeyscv.
	 * @return the fkeyscv attribute reference
	 */
	public ElementaryRangeReference getFkeyscvReference() {
		return fkeyscv.getReference();
	}

	/**
	 * Getter for fkeyscv attribute.
	 * @return fkeyscv attribute
	 */
	public String getFkeyscv() {
		return fkeyscv.getValue();
	}

	/**
	 * Setter for fkeyscv attribute.
	 * @param fkeyscv the new value of fkeyscv
	 */
	public void setFkeyscv(String fkeyscv) {
		this.fkeyscv.setValue(fkeyscv);
	}
	/**
	 * Gets the reference for attribute fkeysco.
	 * @return the fkeysco attribute reference
	 */
	public ElementaryRangeReference getFkeyscoReference() {
		return fkeysco.getReference();
	}

	/**
	 * Getter for fkeysco attribute.
	 * @return fkeysco attribute
	 */
	public String getFkeysco() {
		return fkeysco.getValue();
	}

	/**
	 * Setter for fkeysco attribute.
	 * @param fkeysco the new value of fkeysco
	 */
	public void setFkeysco(String fkeysco) {
		this.fkeysco.setValue(fkeysco);
	}
}
