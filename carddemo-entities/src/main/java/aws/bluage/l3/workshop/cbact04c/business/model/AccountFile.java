 ...
 * 
 * <p>About 'fdAcctfileRec' field, <br>uml entity: aws.bluage.l3.workshop.cbact04c.business.model.FdAcctfileRec
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.cbact04c.business.model.AccountFile")
@Lazy
@Scope("prototype")
public class AccountFile extends RecordEntity {
	 ...
	 */
	public AccountFile(@Qualifier("Cbact04cContextConfiguration") Configuration configuration) {
		super(configuration);
		setupRoot(root);
	}
