...
public class WsLiterals extends RecordEntity {
	...
	private final Elementary litThispgm = new Elementary(root,new AlphanumericType(8),"COCRDUPC");
	private final Elementary litThistranid = new Elementary(root,new AlphanumericType(4),"CCUP");
	private final Elementary litThismapset = new Elementary(root,new AlphanumericType(8),"COCRDUP ");
	private final Elementary litThismap = new Elementary(root,new AlphanumericType(7),"CCRDUPA");
