 ...
 * 
 * <p>About 'fdTranCatBalRecord' field, <br>uml entity: aws.bluage.l3.workshop.cbtrn02c.business.model.FdTranCatBalRecord
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.cbtrn02c.business.model.TcatbalFile")
@Lazy
@Scope("prototype")
public class TcatbalFile extends RecordEntity {
	 ...
	 */
	public TcatbalFile(@Qualifier("Cbtrn02cContextConfiguration") Configuration configuration) {
		super(configuration);
		setupRoot(root);
	}
