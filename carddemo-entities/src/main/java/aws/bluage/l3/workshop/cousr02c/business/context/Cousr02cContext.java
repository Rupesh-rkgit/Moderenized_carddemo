...
import aws.bluage.l3.workshop.cousr02c.business.model.CarddemoCommarea;
import aws.bluage.l3.workshop.cousr02c.business.model.CcdaCommonMessages;
import aws.bluage.l3.workshop.cousr02c.business.model.CcdaScreenTitle;
import aws.bluage.l3.workshop.cousr02c.business.model.Dfhaid;
import aws.bluage.l3.workshop.cousr02c.business.model.Dfhbmsca;
import aws.bluage.l3.workshop.cousr02c.business.model.Dfhcommarea;
import aws.bluage.l3.workshop.cousr02c.business.model.Dfheiblk;
import aws.bluage.l3.workshop.cousr02c.business.model.Group1;
import aws.bluage.l3.workshop.cousr02c.business.model.SecUserData;
import aws.bluage.l3.workshop.cousr02c.business.model.WsDateTime;
import aws.bluage.l3.workshop.cousr02c.business.model.WsVariables;
...
/**
 * Data simplifier context Cousr02cContext.
 * 
 ...
 * </p>
 * 
 * <p>About 'wsVariables' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.WsVariables
 * <br></p>
 * 
 * <p>About 'carddemoCommarea' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.CarddemoCommarea
 * <br></p>
 * 
 * <p>About 'group1' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.Group1
 * <br></p>
 * 
 * <p>About 'ccdaScreenTitle' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.CcdaScreenTitle
 * <br></p>
 * 
 * <p>About 'wsDateTime' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.WsDateTime
 * <br></p>
 * 
 * <p>About 'ccdaCommonMessages' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.CcdaCommonMessages
 * <br></p>
 * 
 * <p>About 'secUserData' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.SecUserData
 * <br></p>
 * 
 * <p>About 'dfhaid' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.Dfhaid
 * <br></p>
 * 
 * <p>About 'dfhbmsca' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.Dfhbmsca
 * <br></p>
 * 
 * <p>About 'dfheiblk' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.Dfheiblk
 * <br></p>
 * 
 * <p>About 'dfhcommarea' field, <br>uml entity: aws.bluage.l3.workshop.cousr02c.business.model.Dfhcommarea
 * <br></p>
 * 
 */
@Component("aws.bluage.l3.workshop.cousr02c.business.context.Cousr02cContext")
@Lazy
@Scope("prototype")
public class Cousr02cContext extends JicsRuntimeContext {
	 ...
	 */
	public Cousr02cContext (@Qualifier("Cousr02cContextConfiguration") Configuration configuration) {
		super(configuration);
