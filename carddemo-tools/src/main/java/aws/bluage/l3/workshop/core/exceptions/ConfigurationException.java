...
/**
 * Exception class used for configuration exception.
 */
public class ConfigurationException extends RuntimeException {
	...
	/**
	 * Constructs a new configuration exception with {@code null} as its detail
	 ...
	 * automatically incorporated in this configuration exception''s detail
	 * message.
	 *
	 * @param message
	 ...
	 * constructor is useful for configuration exceptions that are little more
